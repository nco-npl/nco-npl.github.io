...
pubcoder.page.id = pubcoder.page.id || 7122;
 ...
 * 
 */
var obj7144_onTap_activeActionGroupIndex = -1;
var obj7144_onTap_runningActionsCount = 0;
var obj7144_onTap_loopCount = 0;
...
obj7144_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7144_onTap_activeActionGroupIndex = -1;
		$("#obj7144").trigger("obj7144_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 7144) {
				console.warn("de-queueing event obj7144." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj7144").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj7144_onTap_activeActionGroupIndex = 0;
...
runjs_7148();
function runjs_7148() {
	window.obj7144_onTap_runningActionsCount = obj7144_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj7144_onTap_runningActionsCount = window.obj7144_onTap_runningActionsCount - 1;
if (window.obj7144_onTap_runningActionsCount < 0) {
	window.obj7144_onTap_runningActionsCount = 0;
} else if (window.obj7144_onTap_runningActionsCount == 0) {
	obj7144_onTap_actionGroup1();
}
	}, 1);
}
...
obj7144_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj7144: Event Touch Down
 *
 */
$("#obj7144").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj7144_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj7144_onTap is still running");
	return;
}
var obj7144_onTap_runningActionsCount = 0;
var obj7144_onTap_loopCount = 0;
obj7144_onTap_actionGroup0();
});
...
$("#obj7140").trigger('SCEventShow');
$("#obj7142").trigger('SCEventShow');
$("#obj7123").trigger('SCEventShow');
$("#obj7144").trigger('SCEventShow');
$("#obj7149").trigger('SCEventShow');
