...
pubcoder.page.id = pubcoder.page.id || 1510;
...
function switchImage_8189() {
	...
	var switchHelperId = "switchHelper517"
	var switchHelperRef = "#switchHelper517"
	var switchId = "517";
	var toSwitchId = "517";
	var fadeDuration = "0s";
...
function switchImage_8195() {
	...
	var switchHelperId = "switchHelper518"
	var switchHelperRef = "#switchHelper518"
	var switchId = "518";
	var toSwitchId = "518";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_8183() {
	...
	var switchHelperId = "switchHelper519"
	var switchHelperRef = "#switchHelper519"
	var switchId = "519";
	var toSwitchId = "519";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj2362").trigger('SCEventShow');
$("#obj2360").trigger('SCEventShow');
$("#obj2624").trigger('SCEventShow');
$("#obj2622").trigger('SCEventShow');
$("#obj2364").trigger('SCEventShow');
$("#obj2366").trigger('SCEventShow');
$("#obj2620").trigger('SCEventShow');
$("#obj2618").trigger('SCEventShow');
$("#obj2368").trigger('SCEventShow');
$("#obj2370").trigger('SCEventShow');
$("#obj2614").trigger('SCEventShow');
$("#obj2616").trigger('SCEventShow');
