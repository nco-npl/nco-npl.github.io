...
pubcoder.page.id = pubcoder.page.id || 1511;
 ...
 * 
 */
var obj6772_onTap_activeActionGroupIndex = -1;
var obj6772_onTap_runningActionsCount = 0;
var obj6772_onTap_loopCount = 0;
...
obj6772_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6772_onTap_activeActionGroupIndex = -1;
		$("#obj6772").trigger("obj6772_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 6772) {
				console.warn("de-queueing event obj6772." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj6772").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj6772_onTap_activeActionGroupIndex = 0;
...
runjs_6776();
function runjs_6776() {
	window.obj6772_onTap_runningActionsCount = obj6772_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj6772_onTap_runningActionsCount = window.obj6772_onTap_runningActionsCount - 1;
if (window.obj6772_onTap_runningActionsCount < 0) {
	window.obj6772_onTap_runningActionsCount = 0;
} else if (window.obj6772_onTap_runningActionsCount == 0) {
	obj6772_onTap_actionGroup1();
}
	}, 1);
}
...
obj6772_onTap_actionGroup1 = function(){
...
function switchImage_8189() {
	...
	var switchHelperId = "switchHelper525"
	var switchHelperRef = "#switchHelper525"
	var switchId = "525";
	var toSwitchId = "525";
	var fadeDuration = "0s";
...
function switchImage_8195() {
	...
	var switchHelperId = "switchHelper526"
	var switchHelperRef = "#switchHelper526"
	var switchId = "526";
	var toSwitchId = "526";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_8183() {
	...
	var switchHelperId = "switchHelper527"
	var switchHelperRef = "#switchHelper527"
	var switchId = "527";
	var toSwitchId = "527";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj6772: Event Touch Down
 *
 */
$("#obj6772").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj6772_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj6772_onTap is still running");
	return;
}
var obj6772_onTap_runningActionsCount = 0;
var obj6772_onTap_loopCount = 0;
obj6772_onTap_actionGroup0();
});
...
$("#obj2632").trigger('SCEventShow');
$("#obj2634").trigger('SCEventShow');
