...
pubcoder.page.id = pubcoder.page.id || 1512;
...
function switchImage_8195() {
	...
	var switchHelperId = "switchHelper534"
	var switchHelperRef = "#switchHelper534"
	var switchId = "534";
	var toSwitchId = "534";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj1659").trigger('SCEventShow');
$("#obj2380").trigger('SCEventShow');
$("#obj2382").trigger('SCEventShow');
