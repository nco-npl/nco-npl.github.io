...
pubcoder.project.title = pubcoder.project.title || "हाम्रो सेरोफेरो - विषयक्षेत्र १";
...
function switchImage_8189() {
	...
	var switchHelperId = "switchHelper84"
	var switchHelperRef = "#switchHelper84"
	var switchId = "84";
	var toSwitchId = "84";
	var fadeDuration = "0s";
 ...
 *
 */
$("#obj1169").bind(PubCoder.Events.Tap + " keydown", function(event) {
 ...
 *
 */
$("#obj1167").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
