...
pubcoder.page.id = pubcoder.page.id || 3807;
...
function switchImage_13897() {
	...
	var switchHelperId = "switchHelper114"
	var switchHelperRef = "#switchHelper114"
	var switchId = "114";
	var toSwitchId = "114";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_13885() {
	...
	var switchHelperId = "switchHelper115"
	var switchHelperRef = "#switchHelper115"
	var switchId = "115";
	var toSwitchId = "115";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj3998").trigger('SCEventShow');
$("#obj4204").trigger('SCEventShow');
$("#obj4525").trigger('SCEventShow');
$("#obj10087").trigger('SCEventShow');
$("#obj10165").trigger('SCEventShow');
