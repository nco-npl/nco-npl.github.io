...
pubcoder.page.id = pubcoder.page.id || 10449;
...
function switchImage_13891() {
	...
	var switchHelperId = "switchHelper365"
	var switchHelperRef = "#switchHelper365"
	var switchId = "365";
	var toSwitchId = "365";
	var fadeDuration = "0s";
...
function switchImage_13897() {
	...
	var switchHelperId = "switchHelper366"
	var switchHelperRef = "#switchHelper366"
	var switchId = "366";
	var toSwitchId = "366";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj10484").trigger('SCEventShow');
$("#obj10482").trigger('SCEventShow');
$("#obj10480").trigger('SCEventShow');
$("#obj10476").trigger('SCEventShow');
$("#obj10472").trigger('SCEventShow');
