...
pubcoder.page.id = pubcoder.page.id || 3836;
...
function switchImage_13897() {
	...
	var switchHelperId = "switchHelper374"
	var switchHelperRef = "#switchHelper374"
	var switchId = "374";
	var toSwitchId = "374";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_13885() {
	...
	var switchHelperId = "switchHelper375"
	var switchHelperRef = "#switchHelper375"
	var switchId = "375";
	var toSwitchId = "375";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj4475").trigger('SCEventShow');
$("#obj4723").trigger('SCEventShow');
$("#obj4725").trigger('SCEventShow');
$("#obj4477").trigger('SCEventShow');
$("#obj10149").trigger('SCEventShow');
$("#obj10225").trigger('SCEventShow');
