...
pubcoder.project.title = pubcoder.project.title || "हाम्रो सेरोफेरो - विषयक्षेत्र १०";
pubcoder.page.id = pubcoder.page.id || 3802;
 ...
 * 
 */
var obj4513_onTap_activeActionGroupIndex = -1;
var obj4513_onTap_runningActionsCount = 0;
var obj4513_onTap_loopCount = 0;
var obj4507_onTap_activeActionGroupIndex = -1;
var obj4507_onTap_runningActionsCount = 0;
var obj4507_onTap_loopCount = 0;
var obj4511_onTap_activeActionGroupIndex = -1;
var obj4511_onTap_runningActionsCount = 0;
var obj4511_onTap_loopCount = 0;
var obj4509_onTap_activeActionGroupIndex = -1;
var obj4509_onTap_runningActionsCount = 0;
var obj4509_onTap_loopCount = 0;
...
var obj14136_onTap_activeActionGroupIndex = -1;
var obj14136_onTap_runningActionsCount = 0;
var obj14136_onTap_loopCount = 0;
var obj14139_onTap_activeActionGroupIndex = -1;
var obj14139_onTap_runningActionsCount = 0;
var obj14139_onTap_loopCount = 0;
...
obj4513_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4513_onTap_activeActionGroupIndex = -1;
		$("#obj4513").trigger("obj4513_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4513) {
				console.warn("de-queueing event obj4513." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4513").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4513_onTap_activeActionGroupIndex = 0;
	

//	action: hide
//	selector: obj#obj13920 
hide_13931();
function hide_13931() {
	var selector = "#obj13920";
	...
	window.obj4513_onTap_runningActionsCount = obj4513_onTap_runningActionsCount + 1;
	...
	if ($(selector).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			...
			window.obj4513_onTap_runningActionsCount = window.obj4513_onTap_runningActionsCount - 1;
if (window.obj4513_onTap_runningActionsCount < 0) {
	window.obj4513_onTap_runningActionsCount = 0;
} else if (window.obj4513_onTap_runningActionsCount == 0) {
	obj4513_onTap_actionGroup1();
}
		}, 1);
		return;
	};
...
obj4513_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4513_onTap_activeActionGroupIndex = -1;
		$("#obj4513").trigger("obj4513_onTap_ended");
...
//	action: hide
//	selector: obj#obj13918 
hide_13932();
function hide_13932() {
	var selector = "#obj13918";
	$(selector).removeClass("animated bounce flash pulse rubberBand shake headShake swing tada wobble jello bounceIn bounceInDown bounceInLeft bounceInRight bounceInUp bounceOut bounceOutDown bounceOutLeft bounceOutRight bounceOutUp fadeIn fadeInDown fadeInDownBig fadeInLeft fadeInLeftBig fadeInRight fadeInRightBig fadeInUp fadeInUpBig fadeOut fadeOutDown fadeOutDownBig fadeOutLeft fadeOutLeftBig fadeOutRight fadeOutRightBig fadeOutUp fadeOutUpBig flipInX flipInY flipOutX flipOutY lightSpeedIn lightSpeedOut rotateIn rotateInDownLeft rotateInDownRight rotateInUpLeft rotateInUpRight rotateOut rotateOutDownLeft rotateOutDownRight rotateOutUpLeft rotateOutUpRight hinge jackInTheBox rollIn rollOut zoomIn zoomInDown zoomInLeft zoomInRight zoomInUp zoomOut zoomOutDown zoomOutLeft zoomOutRight zoomOutUp slideInDown slideInLeft slideInRight slideInUp slideOutDown slideOutLeft slideOutRight slideOutUp heartBeat");
...
obj4513_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4513_onTap_activeActionGroupIndex = -1;
		$("#obj4513").trigger("obj4513_onTap_ended");
	...
	window.obj4513_onTap_activeActionGroupIndex = 2;
	

//	action: hide
//	selector: obj#obj13921 
hide_13933();
function hide_13933() {
	var selector = "#obj13921";
	$(selector).removeClass("animated bounce flash pulse rubberBand shake headShake swing tada wobble jello bounceIn bounceInDown bounceInLeft bounceInRight bounceInUp bounceOut bounceOutDown bounceOutLeft bounceOutRight bounceOutUp fadeIn fadeInDown fadeInDownBig fadeInLeft fadeInLeftBig fadeInRight fadeInRightBig fadeInUp fadeInUpBig fadeOut fadeOutDown fadeOutDownBig fadeOutLeft fadeOutLeftBig fadeOutRight fadeOutRightBig fadeOutUp fadeOutUpBig flipInX flipInY flipOutX flipOutY lightSpeedIn lightSpeedOut rotateIn rotateInDownLeft rotateInDownRight rotateInUpLeft rotateInUpRight rotateOut rotateOutDownLeft rotateOutDownRight rotateOutUpLeft rotateOutUpRight hinge jackInTheBox rollIn rollOut zoomIn zoomInDown zoomInLeft zoomInRight zoomInUp zoomOut zoomOutDown zoomOutLeft zoomOutRight zoomOutUp slideInDown slideInLeft slideInRight slideInUp slideOutDown slideOutLeft slideOutRight slideOutUp heartBeat");
...
obj4513_onTap_actionGroup3 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4513_onTap_activeActionGroupIndex = -1;
		$("#obj4513").trigger("obj4513_onTap_ended");
	...
	window.obj4513_onTap_activeActionGroupIndex = 3;
...
obj4513_onTap_actionGroup4 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4513_onTap_activeActionGroupIndex = -1;
		$("#obj4513").trigger("obj4513_onTap_ended");
	...
	window.obj4513_onTap_activeActionGroupIndex = 4;
...
playAudioFile_13944();
function playAudioFile_13944() {
	window.obj4513_onTap_runningActionsCount = obj4513_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile13944")[0];
	...
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile13944");
			$("#obj_audio_playSoundFile13944").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj4513_onTap_runningActionsCount = window.obj4513_onTap_runningActionsCount - 1;
if (window.obj4513_onTap_runningActionsCount < 0) {
	window.obj4513_onTap_runningActionsCount = 0;
} else if (window.obj4513_onTap_runningActionsCount == 0) {
	obj4513_onTap_actionGroup5();
}
			});
		} else {
...
obj4513_onTap_actionGroup5 = function(){
	...
	window.obj4513_onTap_activeActionGroupIndex = 5;
...
obj4507_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4507_onTap_activeActionGroupIndex = -1;
		$("#obj4507").trigger("obj4507_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4507) {
				console.warn("de-queueing event obj4507." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4507").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4507_onTap_activeActionGroupIndex = 0;
...
function hide_13927() {
	...
	window.obj4507_onTap_runningActionsCount = obj4507_onTap_runningActionsCount + 1;
	...
	if ($(selector).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(selector).css("display", "none");
			window.obj4507_onTap_runningActionsCount = window.obj4507_onTap_runningActionsCount - 1;
if (window.obj4507_onTap_runningActionsCount < 0) {
	window.obj4507_onTap_runningActionsCount = 0;
} else if (window.obj4507_onTap_runningActionsCount == 0) {
	obj4507_onTap_actionGroup1();
}
		}, 1);
		return;
	};
...
obj4507_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4507_onTap_activeActionGroupIndex = -1;
		$("#obj4507").trigger("obj4507_onTap_ended");
...
obj4507_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4507_onTap_activeActionGroupIndex = -1;
		$("#obj4507").trigger("obj4507_onTap_ended");
	...
	window.obj4507_onTap_activeActionGroupIndex = 2;
...
obj4507_onTap_actionGroup3 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4507_onTap_activeActionGroupIndex = -1;
		$("#obj4507").trigger("obj4507_onTap_ended");
	...
	window.obj4507_onTap_activeActionGroupIndex = 3;
...
obj4507_onTap_actionGroup4 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4507_onTap_activeActionGroupIndex = -1;
		$("#obj4507").trigger("obj4507_onTap_ended");
	...
	window.obj4507_onTap_activeActionGroupIndex = 4;
...
//	action: playAudioFile
playAudioFile_13943();
function playAudioFile_13943() {
	window.obj4507_onTap_runningActionsCount = obj4507_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile13943")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile13943");
			$("#obj_audio_playSoundFile13943").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj4507_onTap_runningActionsCount = window.obj4507_onTap_runningActionsCount - 1;
if (window.obj4507_onTap_runningActionsCount < 0) {
	window.obj4507_onTap_runningActionsCount = 0;
} else if (window.obj4507_onTap_runningActionsCount == 0) {
	obj4507_onTap_actionGroup5();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj4507_onTap_actionGroup5 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4507_onTap_activeActionGroupIndex = -1;
		$("#obj4507").trigger("obj4507_onTap_ended");
	...
	window.obj4507_onTap_activeActionGroupIndex = 5;
...
obj4511_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4511_onTap_activeActionGroupIndex = -1;
		$("#obj4511").trigger("obj4511_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4511) {
				console.warn("de-queueing event obj4511." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4511").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4511_onTap_activeActionGroupIndex = 0;
...
function hide_13939() {
	...
	window.obj4511_onTap_runningActionsCount = obj4511_onTap_runningActionsCount + 1;
	...
	if ($(selector).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(selector).css("display", "none");
			window.obj4511_onTap_runningActionsCount = window.obj4511_onTap_runningActionsCount - 1;
if (window.obj4511_onTap_runningActionsCount < 0) {
	window.obj4511_onTap_runningActionsCount = 0;
} else if (window.obj4511_onTap_runningActionsCount == 0) {
	obj4511_onTap_actionGroup1();
}
		}, 1);
		return;
	};
...
obj4511_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4511_onTap_activeActionGroupIndex = -1;
		$("#obj4511").trigger("obj4511_onTap_ended");
...
obj4511_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4511_onTap_activeActionGroupIndex = -1;
		$("#obj4511").trigger("obj4511_onTap_ended");
	...
	window.obj4511_onTap_activeActionGroupIndex = 2;
...
obj4511_onTap_actionGroup3 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4511_onTap_activeActionGroupIndex = -1;
		$("#obj4511").trigger("obj4511_onTap_ended");
	...
	window.obj4511_onTap_activeActionGroupIndex = 3;
...
obj4511_onTap_actionGroup4 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4511_onTap_activeActionGroupIndex = -1;
		$("#obj4511").trigger("obj4511_onTap_ended");
	...
	window.obj4511_onTap_activeActionGroupIndex = 4;
...
//	action: playAudioFile
playAudioFile_13946();
function playAudioFile_13946() {
	window.obj4511_onTap_runningActionsCount = obj4511_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile13946")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile13946");
			$("#obj_audio_playSoundFile13946").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj4511_onTap_runningActionsCount = window.obj4511_onTap_runningActionsCount - 1;
if (window.obj4511_onTap_runningActionsCount < 0) {
	window.obj4511_onTap_runningActionsCount = 0;
} else if (window.obj4511_onTap_runningActionsCount == 0) {
	obj4511_onTap_actionGroup5();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj4511_onTap_actionGroup5 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4511_onTap_activeActionGroupIndex = -1;
		$("#obj4511").trigger("obj4511_onTap_ended");
	...
	window.obj4511_onTap_activeActionGroupIndex = 5;
...
obj4509_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4509_onTap_activeActionGroupIndex = -1;
		$("#obj4509").trigger("obj4509_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4509) {
				console.warn("de-queueing event obj4509." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4509").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4509_onTap_activeActionGroupIndex = 0;
...
function hide_13935() {
	...
	window.obj4509_onTap_runningActionsCount = obj4509_onTap_runningActionsCount + 1;
	...
	if ($(selector).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(selector).css("display", "none");
			window.obj4509_onTap_runningActionsCount = window.obj4509_onTap_runningActionsCount - 1;
if (window.obj4509_onTap_runningActionsCount < 0) {
	window.obj4509_onTap_runningActionsCount = 0;
} else if (window.obj4509_onTap_runningActionsCount == 0) {
	obj4509_onTap_actionGroup1();
}
		}, 1);
		return;
	};
...
obj4509_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4509_onTap_activeActionGroupIndex = -1;
		$("#obj4509").trigger("obj4509_onTap_ended");
...
obj4509_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4509_onTap_activeActionGroupIndex = -1;
		$("#obj4509").trigger("obj4509_onTap_ended");
	...
	window.obj4509_onTap_activeActionGroupIndex = 2;
...
obj4509_onTap_actionGroup3 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4509_onTap_activeActionGroupIndex = -1;
		$("#obj4509").trigger("obj4509_onTap_ended");
	...
	window.obj4509_onTap_activeActionGroupIndex = 3;
...
obj4509_onTap_actionGroup4 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4509_onTap_activeActionGroupIndex = -1;
		$("#obj4509").trigger("obj4509_onTap_ended");
	...
	window.obj4509_onTap_activeActionGroupIndex = 4;
...
//	action: playAudioFile
playAudioFile_13945();
function playAudioFile_13945() {
	window.obj4509_onTap_runningActionsCount = obj4509_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile13945")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile13945");
			$("#obj_audio_playSoundFile13945").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj4509_onTap_runningActionsCount = window.obj4509_onTap_runningActionsCount - 1;
if (window.obj4509_onTap_runningActionsCount < 0) {
	window.obj4509_onTap_runningActionsCount = 0;
} else if (window.obj4509_onTap_runningActionsCount == 0) {
	obj4509_onTap_actionGroup5();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj4509_onTap_actionGroup5 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4509_onTap_activeActionGroupIndex = -1;
		$("#obj4509").trigger("obj4509_onTap_ended");
	...
	window.obj4509_onTap_activeActionGroupIndex = 5;
...
function switchImage_13891() {
	...
	var switchHelperId = "switchHelper73"
	var switchHelperRef = "#switchHelper73"
	var switchId = "73";
	var toSwitchId = "73";
	var fadeDuration = "0s";
...
function switchImage_13897() {
	...
	var switchHelperId = "switchHelper74"
	var switchHelperRef = "#switchHelper74"
	var switchId = "74";
	var toSwitchId = "74";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_13885() {
	...
	var switchHelperId = "switchHelper75"
	var switchHelperRef = "#switchHelper75"
	var switchId = "75";
	var toSwitchId = "75";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
obj14136_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj14136_onTap_activeActionGroupIndex = -1;
		$("#obj14136").trigger("obj14136_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 14136) {
				console.warn("de-queueing event obj14136." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj14136").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj14136_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
goToPage_14138();
function goToPage_14138() {
	window.obj14136_onTap_runningActionsCount = obj14136_onTap_runningActionsCount + 1;
	$("#anchor76")[0].click();
	window.obj14136_onTap_runningActionsCount = window.obj14136_onTap_runningActionsCount - 1;
if (window.obj14136_onTap_runningActionsCount < 0) {
	window.obj14136_onTap_runningActionsCount = 0;
} else if (window.obj14136_onTap_runningActionsCount == 0) {
	obj14136_onTap_actionGroup1();
}
}
...
obj14136_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj14136_onTap_activeActionGroupIndex = -1;
		$("#obj14136").trigger("obj14136_onTap_ended");
...
obj14139_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj14139_onTap_activeActionGroupIndex = -1;
		$("#obj14139").trigger("obj14139_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 14139) {
				console.warn("de-queueing event obj14139." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj14139").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj14139_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
goToPage_14141();
function goToPage_14141() {
	window.obj14139_onTap_runningActionsCount = obj14139_onTap_runningActionsCount + 1;
	$("#anchor77")[0].click();
	window.obj14139_onTap_runningActionsCount = window.obj14139_onTap_runningActionsCount - 1;
if (window.obj14139_onTap_runningActionsCount < 0) {
	window.obj14139_onTap_runningActionsCount = 0;
} else if (window.obj14139_onTap_runningActionsCount == 0) {
	obj14139_onTap_actionGroup1();
}
}
...
obj14139_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj14139_onTap_activeActionGroupIndex = -1;
		$("#obj14139").trigger("obj14139_onTap_ended");
...
/*
 *
 *   obj4513: Event Touch Down
 *
 */
$("#obj4513").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4513_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4513_onTap is still running");
	return;
}
var obj4513_onTap_runningActionsCount = 0;
var obj4513_onTap_loopCount = 0;
obj4513_onTap_actionGroup0();
});
...
/*
 *
 *   obj4507: Event Touch Down
 *
 */
$("#obj4507").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4507_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4507_onTap is still running");
	return;
}
var obj4507_onTap_runningActionsCount = 0;
var obj4507_onTap_loopCount = 0;
obj4507_onTap_actionGroup0();
});
...
/*
 *
 *   obj4511: Event Touch Down
 *
 */
$("#obj4511").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4511_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4511_onTap is still running");
	return;
}
var obj4511_onTap_runningActionsCount = 0;
var obj4511_onTap_loopCount = 0;
obj4511_onTap_actionGroup0();
});
...
/*
 *
 *   obj4509: Event Touch Down
 *
 */
$("#obj4509").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4509_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4509_onTap is still running");
	return;
}
var obj4509_onTap_runningActionsCount = 0;
var obj4509_onTap_loopCount = 0;
obj4509_onTap_actionGroup0();
});
...
/*
 *
 *   obj14136: Event Touch Down
 *
 */
$("#obj14136").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj14136_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj14136_onTap is still running");
	return;
}
var obj14136_onTap_runningActionsCount = 0;
var obj14136_onTap_loopCount = 0;
obj14136_onTap_actionGroup0();
});
...
/*
 *
 *   obj14139: Event Touch Down
 *
 */
$("#obj14139").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj14139_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj14139_onTap is still running");
	return;
}
var obj14139_onTap_runningActionsCount = 0;
var obj14139_onTap_loopCount = 0;
obj14139_onTap_actionGroup0();
});
...
$("#obj3983").trigger('SCEventShow');
$("#obj4182").trigger('SCEventShow');
$("#obj4180").trigger('SCEventShow');
$("#obj4513").trigger('SCEventShow');
$("#obj4507").trigger('SCEventShow');
$("#obj4511").trigger('SCEventShow');
$("#obj4509").trigger('SCEventShow');
$("#obj10077").trigger('SCEventShow');
$("#obj10155").trigger('SCEventShow');
$("#obj13887").trigger('SCEventShow');
$("#obj13858").trigger('SCEventShow');
$("#obj14136").trigger('SCEventShow');
