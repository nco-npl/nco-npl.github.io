...
function switchImage_7828() {
	...
	var switchHelperId = "switchHelper23"
	var switchHelperRef = "#switchHelper23"
	var switchId = "23";
	var toSwitchId = "23";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
 ...
 *
 */
$("#obj6973").bind(PubCoder.Events.Tap + " keydown", function(event) {
...
$("#obj3252").trigger('SCEventShow');
$("#obj2895").trigger('SCEventShow');
$("#obj3256").trigger('SCEventShow');
$("#obj3526").trigger('SCEventShow');
$("#obj3524").trigger('SCEventShow');
$("#obj3942").trigger('SCEventShow');
