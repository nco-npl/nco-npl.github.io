 ...
 * 
 */
var obj6983_onTap_activeActionGroupIndex = -1;
var obj6983_onTap_runningActionsCount = 0;
var obj6983_onTap_loopCount = 0;
...
obj6983_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6983_onTap_activeActionGroupIndex = -1;
		$("#obj6983").trigger("obj6983_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 6983) {
				console.warn("de-queueing event obj6983." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj6983").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj6983_onTap_activeActionGroupIndex = 0;
...
runjs_6987();
function runjs_6987() {
	window.obj6983_onTap_runningActionsCount = obj6983_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj6983_onTap_runningActionsCount = window.obj6983_onTap_runningActionsCount - 1;
if (window.obj6983_onTap_runningActionsCount < 0) {
	window.obj6983_onTap_runningActionsCount = 0;
} else if (window.obj6983_onTap_runningActionsCount == 0) {
	obj6983_onTap_actionGroup1();
}
	}, 1);
}
...
obj6983_onTap_actionGroup1 = function(){
...
function switchImage_7834() {
	...
	var switchHelperId = "switchHelper28"
	var switchHelperRef = "#switchHelper28"
	var switchId = "28";
	var toSwitchId = "28";
	var fadeDuration = "0s";
...
function switchImage_7828() {
	...
	var switchHelperId = "switchHelper30"
	var switchHelperRef = "#switchHelper30"
	var switchId = "30";
	var toSwitchId = "30";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj6983: Event Touch Down
 *
 */
$("#obj6983").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj6983_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj6983_onTap is still running");
	return;
}
var obj6983_onTap_runningActionsCount = 0;
var obj6983_onTap_loopCount = 0;
obj6983_onTap_actionGroup0();
});
...
$("#obj3528").trigger('SCEventShow');
$("#obj2898").trigger('SCEventShow');
$("#obj3534").trigger('SCEventShow');
$("#obj3532").trigger('SCEventShow');
$("#obj3530").trigger('SCEventShow');
$("#obj3947").trigger('SCEventShow');
$("#obj6983").trigger('SCEventShow');
