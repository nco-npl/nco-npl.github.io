...
pubcoder.page.id = pubcoder.page.id || 2917;
 ...
 * 
 */
var obj7006_onTap_activeActionGroupIndex = -1;
var obj7006_onTap_runningActionsCount = 0;
var obj7006_onTap_loopCount = 0;
...
obj7006_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7006_onTap_activeActionGroupIndex = -1;
		$("#obj7006").trigger("obj7006_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 7006) {
				console.warn("de-queueing event obj7006." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj7006").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj7006_onTap_activeActionGroupIndex = 0;
...
runjs_7010();
function runjs_7010() {
	window.obj7006_onTap_runningActionsCount = obj7006_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj7006_onTap_runningActionsCount = window.obj7006_onTap_runningActionsCount - 1;
if (window.obj7006_onTap_runningActionsCount < 0) {
	window.obj7006_onTap_runningActionsCount = 0;
} else if (window.obj7006_onTap_runningActionsCount == 0) {
	obj7006_onTap_actionGroup1();
}
	}, 1);
}
...
obj7006_onTap_actionGroup1 = function(){
...
function switchImage_7828() {
	...
	var switchHelperId = "switchHelper177"
	var switchHelperRef = "#switchHelper177"
	var switchId = "177";
	var toSwitchId = "177";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj7006: Event Touch Down
 *
 */
$("#obj7006").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj7006_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj7006_onTap is still running");
	return;
}
var obj7006_onTap_runningActionsCount = 0;
var obj7006_onTap_loopCount = 0;
obj7006_onTap_actionGroup0();
});
...
$("#obj3014").trigger('SCEventShow');
$("#obj7065").trigger('SCEventShow');
$("#obj3316").trigger('SCEventShow');
$("#obj3430").trigger('SCEventShow');
$("#obj7063").trigger('SCEventShow');
$("#obj3584").trigger('SCEventShow');
$("#obj7073").trigger('SCEventShow');
$("#obj7077").trigger('SCEventShow');
$("#obj7075").trigger('SCEventShow');
$("#obj7071").trigger('SCEventShow');
$("#obj7079").trigger('SCEventShow');
$("#obj7083").trigger('SCEventShow');
$("#obj7067").trigger('SCEventShow');
$("#obj7081").trigger('SCEventShow');
$("#obj7069").trigger('SCEventShow');
$("#obj3020").trigger('SCEventShow');
$("#obj3318").trigger('SCEventShow');
$("#obj4022").trigger('SCEventShow');
$("#obj7006").trigger('SCEventShow');
$("#obj7223").trigger('SCEventShow');
