...
pubcoder.page.id = pubcoder.page.id || 2918;
 ...
 * 
 */
var obj7015_onTap_activeActionGroupIndex = -1;
var obj7015_onTap_runningActionsCount = 0;
var obj7015_onTap_loopCount = 0;
...
obj7015_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7015_onTap_activeActionGroupIndex = -1;
		$("#obj7015").trigger("obj7015_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 7015) {
				console.warn("de-queueing event obj7015." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj7015").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj7015_onTap_activeActionGroupIndex = 0;
...
runjs_7019();
function runjs_7019() {
	window.obj7015_onTap_runningActionsCount = obj7015_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj7015_onTap_runningActionsCount = window.obj7015_onTap_runningActionsCount - 1;
if (window.obj7015_onTap_runningActionsCount < 0) {
	window.obj7015_onTap_runningActionsCount = 0;
} else if (window.obj7015_onTap_runningActionsCount == 0) {
	obj7015_onTap_actionGroup1();
}
	}, 1);
}
...
obj7015_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj7015: Event Touch Down
 *
 */
$("#obj7015").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj7015_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj7015_onTap is still running");
	return;
}
var obj7015_onTap_runningActionsCount = 0;
var obj7015_onTap_loopCount = 0;
obj7015_onTap_actionGroup0();
});
...
$("#obj3023").trigger('SCEventShow');
$("#obj3320").trigger('SCEventShow');
$("#obj3322").trigger('SCEventShow');
$("#obj3586").trigger('SCEventShow');
$("#obj3434").trigger('SCEventShow');
$("#obj3432").trigger('SCEventShow');
$("#obj3324").trigger('SCEventShow');
$("#obj4024").trigger('SCEventShow');
$("#obj7015").trigger('SCEventShow');
