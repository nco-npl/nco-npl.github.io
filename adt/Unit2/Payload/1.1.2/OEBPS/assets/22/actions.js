...
pubcoder.page.id = pubcoder.page.id || 2919;
 ...
 * 
 */
var obj7022_onTap_activeActionGroupIndex = -1;
var obj7022_onTap_runningActionsCount = 0;
var obj7022_onTap_loopCount = 0;
...
obj7022_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7022_onTap_activeActionGroupIndex = -1;
		$("#obj7022").trigger("obj7022_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 7022) {
				console.warn("de-queueing event obj7022." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj7022").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj7022_onTap_activeActionGroupIndex = 0;
...
runjs_7026();
function runjs_7026() {
	window.obj7022_onTap_runningActionsCount = obj7022_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj7022_onTap_runningActionsCount = window.obj7022_onTap_runningActionsCount - 1;
if (window.obj7022_onTap_runningActionsCount < 0) {
	window.obj7022_onTap_runningActionsCount = 0;
} else if (window.obj7022_onTap_runningActionsCount == 0) {
	obj7022_onTap_actionGroup1();
}
	}, 1);
}
...
obj7022_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj7022: Event Touch Down
 *
 */
$("#obj7022").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj7022_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj7022_onTap is still running");
	return;
}
var obj7022_onTap_runningActionsCount = 0;
var obj7022_onTap_loopCount = 0;
obj7022_onTap_actionGroup0();
});
...
$("#obj3026").trigger('SCEventShow');
$("#obj3588").trigger('SCEventShow');
$("#obj3436").trigger('SCEventShow');
$("#obj3951").trigger('SCEventShow');
$("#obj4026").trigger('SCEventShow');
$("#obj7022").trigger('SCEventShow');
$("#obj4134").trigger('SCEventShow');
