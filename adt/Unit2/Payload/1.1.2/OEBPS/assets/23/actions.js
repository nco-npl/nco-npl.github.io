...
pubcoder.page.id = pubcoder.page.id || 2920;
...
function switchImage_7828() {
	...
	var switchHelperId = "switchHelper201"
	var switchHelperRef = "#switchHelper201"
	var switchId = "201";
	var toSwitchId = "201";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj3029").trigger('SCEventShow');
$("#obj3328").trigger('SCEventShow');
