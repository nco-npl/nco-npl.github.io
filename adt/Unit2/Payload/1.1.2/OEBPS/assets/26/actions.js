...
pubcoder.page.id = pubcoder.page.id || 2923;
 ...
 * 
 */
var obj7029_onTap_activeActionGroupIndex = -1;
var obj7029_onTap_runningActionsCount = 0;
var obj7029_onTap_loopCount = 0;
...
obj7029_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7029_onTap_activeActionGroupIndex = -1;
		$("#obj7029").trigger("obj7029_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 7029) {
				console.warn("de-queueing event obj7029." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj7029").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj7029_onTap_activeActionGroupIndex = 0;
...
runjs_7033();
function runjs_7033() {
	window.obj7029_onTap_runningActionsCount = obj7029_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj7029_onTap_runningActionsCount = window.obj7029_onTap_runningActionsCount - 1;
if (window.obj7029_onTap_runningActionsCount < 0) {
	window.obj7029_onTap_runningActionsCount = 0;
} else if (window.obj7029_onTap_runningActionsCount == 0) {
	obj7029_onTap_actionGroup1();
}
	}, 1);
}
...
obj7029_onTap_actionGroup1 = function(){
...
function switchImage_7834() {
	...
	var switchHelperId = "switchHelper223"
	var switchHelperRef = "#switchHelper223"
	var switchId = "223";
	var toSwitchId = "223";
	var fadeDuration = "0s";
...
function switchImage_7840() {
	...
	var switchHelperId = "switchHelper224"
	var switchHelperRef = "#switchHelper224"
	var switchId = "224";
	var toSwitchId = "224";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_7828() {
	...
	var switchHelperId = "switchHelper225"
	var switchHelperRef = "#switchHelper225"
	var switchId = "225";
	var toSwitchId = "225";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj7029: Event Touch Down
 *
 */
$("#obj7029").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj7029_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj7029_onTap is still running");
	return;
}
var obj7029_onTap_runningActionsCount = 0;
var obj7029_onTap_loopCount = 0;
obj7029_onTap_actionGroup0();
});
...
$("#obj3038").trigger('SCEventShow');
$("#obj3336").trigger('SCEventShow');
$("#obj4034").trigger('SCEventShow');
$("#obj7029").trigger('SCEventShow');
$("#obj4142").trigger('SCEventShow');
