...
pubcoder.project.title = pubcoder.project.title || "हाम्रो सेरोफेरो - विषयक्षेत्र २";
pubcoder.page.id = pubcoder.page.id || 2924;
 ...
 * 
 */
var obj3604_onTap_activeActionGroupIndex = -1;
var obj3604_onTap_runningActionsCount = 0;
var obj3604_onTap_loopCount = 0;
var obj3608_onTap_activeActionGroupIndex = -1;
var obj3608_onTap_runningActionsCount = 0;
var obj3608_onTap_loopCount = 0;
var obj3606_onTap_activeActionGroupIndex = -1;
var obj3606_onTap_runningActionsCount = 0;
var obj3606_onTap_loopCount = 0;
...
var obj7853_onTap_activeActionGroupIndex = -1;
var obj7853_onTap_runningActionsCount = 0;
var obj7853_onTap_loopCount = 0;
var obj7856_onTap_activeActionGroupIndex = -1;
var obj7856_onTap_runningActionsCount = 0;
var obj7856_onTap_loopCount = 0;
...
obj3604_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3604_onTap_activeActionGroupIndex = -1;
		$("#obj3604").trigger("obj3604_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 3604) {
				console.warn("de-queueing event obj3604." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj3604").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj3604_onTap_activeActionGroupIndex = 0;
...
//	target: obj6874 
switchImage_7140();
function switchImage_7140() {
	window.obj3604_onTap_runningActionsCount = obj3604_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj6874";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj6874_img";
	var fromImagePath = "../images/obj3604_image.png";
	var toImagePath = "../images/switch230_to.png";
	var switchHelperId = "switchHelper230"
	var switchHelperRef = "#switchHelper230"
	var switchId = "230";
	var toSwitchId = "230";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage7140_from";
	var toSoundObjectId = "#obj_audio_switchImage7140_to";
	var audioFrom;
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj3604_onTap_runningActionsCount = window.obj3604_onTap_runningActionsCount - 1;
if (window.obj3604_onTap_runningActionsCount < 0) {
	window.obj3604_onTap_runningActionsCount = 0;
} else if (window.obj3604_onTap_runningActionsCount == 0) {
	obj3604_onTap_actionGroup1();
}
			}, 1);
	};
...
obj3604_onTap_actionGroup1 = function(){
...
obj3608_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3608_onTap_activeActionGroupIndex = -1;
		$("#obj3608").trigger("obj3608_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 3608) {
				console.warn("de-queueing event obj3608." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj3608").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj3608_onTap_activeActionGroupIndex = 0;
...
//	target: obj6890 
switchImage_7142();
function switchImage_7142() {
	window.obj3608_onTap_runningActionsCount = obj3608_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj6890";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj6890_img";
	var fromImagePath = "../images/obj3608_image.png";
	var toImagePath = "../images/switch230_to.png";
	...
	var toSwitchId = "233";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage7142_from";
	var toSoundObjectId = "#obj_audio_switchImage7142_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj3608_onTap_runningActionsCount = window.obj3608_onTap_runningActionsCount - 1;
if (window.obj3608_onTap_runningActionsCount < 0) {
	window.obj3608_onTap_runningActionsCount = 0;
} else if (window.obj3608_onTap_runningActionsCount == 0) {
	obj3608_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj3608_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj3608_onTap_activeActionGroupIndex = -1;
		$("#obj3608").trigger("obj3608_onTap_ended");
...
obj3606_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3606_onTap_activeActionGroupIndex = -1;
		$("#obj3606").trigger("obj3606_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 3606) {
				console.warn("de-queueing event obj3606." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj3606").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj3606_onTap_activeActionGroupIndex = 0;
...
//	target: obj6887 
switchImage_7141();
function switchImage_7141() {
	window.obj3606_onTap_runningActionsCount = obj3606_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj6887";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj6887_img";
	var fromImagePath = "../images/obj3606_image.png";
	var toImagePath = "../images/switch230_to.png";
	var switchHelperId = "switchHelper237"
	var switchHelperRef = "#switchHelper237"
	var switchId = "237";
	var toSwitchId = "237";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage7141_from";
	var toSoundObjectId = "#obj_audio_switchImage7141_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj3606_onTap_runningActionsCount = window.obj3606_onTap_runningActionsCount - 1;
if (window.obj3606_onTap_runningActionsCount < 0) {
	window.obj3606_onTap_runningActionsCount = 0;
} else if (window.obj3606_onTap_runningActionsCount == 0) {
	obj3606_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj3606_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj3606_onTap_activeActionGroupIndex = -1;
		$("#obj3606").trigger("obj3606_onTap_ended");
...
function switchImage_7834() {
	...
	var switchHelperId = "switchHelper240"
	var switchHelperRef = "#switchHelper240"
	var switchId = "240";
	var toSwitchId = "240";
	var fadeDuration = "0s";
...
function switchImage_7840() {
	...
	var switchHelperId = "switchHelper241"
	var switchHelperRef = "#switchHelper241"
	var switchId = "241";
	var toSwitchId = "241";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_7828() {
	...
	var switchHelperId = "switchHelper242"
	var switchHelperRef = "#switchHelper242"
	var switchId = "242";
	var toSwitchId = "242";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
obj7853_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7853_onTap_activeActionGroupIndex = -1;
		$("#obj7853").trigger("obj7853_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 7853) {
				console.warn("de-queueing event obj7853." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj7853").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj7853_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
goToPage_7855();
function goToPage_7855() {
	window.obj7853_onTap_runningActionsCount = obj7853_onTap_runningActionsCount + 1;
	$("#anchor243")[0].click();
	window.obj7853_onTap_runningActionsCount = window.obj7853_onTap_runningActionsCount - 1;
if (window.obj7853_onTap_runningActionsCount < 0) {
	window.obj7853_onTap_runningActionsCount = 0;
} else if (window.obj7853_onTap_runningActionsCount == 0) {
	obj7853_onTap_actionGroup1();
}
}
...
obj7853_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj7853_onTap_activeActionGroupIndex = -1;
		$("#obj7853").trigger("obj7853_onTap_ended");
...
obj7856_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7856_onTap_activeActionGroupIndex = -1;
		$("#obj7856").trigger("obj7856_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 7856) {
				console.warn("de-queueing event obj7856." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj7856").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj7856_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
goToPage_7858();
function goToPage_7858() {
	window.obj7856_onTap_runningActionsCount = obj7856_onTap_runningActionsCount + 1;
	$("#anchor244")[0].click();
	window.obj7856_onTap_runningActionsCount = window.obj7856_onTap_runningActionsCount - 1;
if (window.obj7856_onTap_runningActionsCount < 0) {
	window.obj7856_onTap_runningActionsCount = 0;
} else if (window.obj7856_onTap_runningActionsCount == 0) {
	obj7856_onTap_actionGroup1();
}
}
...
obj7856_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj7856_onTap_activeActionGroupIndex = -1;
		$("#obj7856").trigger("obj7856_onTap_ended");
...
/*
 *
 *   obj3604: Event Touch Down
 *
 */
$("#obj3604").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj3604_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj3604_onTap is still running");
	return;
}
var obj3604_onTap_runningActionsCount = 0;
var obj3604_onTap_loopCount = 0;
obj3604_onTap_actionGroup0();
});
...
/*
 *
 *   obj3608: Event Touch Down
 *
 */
$("#obj3608").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj3608_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj3608_onTap is still running");
	return;
}
var obj3608_onTap_runningActionsCount = 0;
var obj3608_onTap_loopCount = 0;
obj3608_onTap_actionGroup0();
});
...
/*
 *
 *   obj3606: Event Touch Down
 *
 */
$("#obj3606").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj3606_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj3606_onTap is still running");
	return;
}
var obj3606_onTap_runningActionsCount = 0;
var obj3606_onTap_loopCount = 0;
obj3606_onTap_actionGroup0();
});
...
/*
 *
 *   obj7853: Event Touch Down
 *
 */
$("#obj7853").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj7853_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj7853_onTap is still running");
	return;
}
var obj7853_onTap_runningActionsCount = 0;
var obj7853_onTap_loopCount = 0;
obj7853_onTap_actionGroup0();
});
...
/*
 *
 *   obj7856: Event Touch Down
 *
 */
$("#obj7856").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj7856_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj7856_onTap is still running");
	return;
}
var obj7856_onTap_runningActionsCount = 0;
var obj7856_onTap_loopCount = 0;
obj7856_onTap_actionGroup0();
});
...
$("#obj3041").trigger('SCEventShow');
$("#obj3338").trigger('SCEventShow');
$("#obj3438").trigger('SCEventShow');
$("#obj3044").trigger('SCEventShow');
$("#obj3340").trigger('SCEventShow');
$("#obj3604").trigger('SCEventShow');
$("#obj3608").trigger('SCEventShow');
$("#obj3606").trigger('SCEventShow');
$("#obj6874").trigger('SCEventShow');
$("#obj6890").trigger('SCEventShow');
$("#obj6887").trigger('SCEventShow');
$("#obj4036").trigger('SCEventShow');
$("#obj4144").trigger('SCEventShow');
$("#obj7830").trigger('SCEventShow');
$("#obj7801").trigger('SCEventShow');
$("#obj7853").trigger('SCEventShow');
$("#obj7856").trigger('SCEventShow');
