...
pubcoder.page.id = pubcoder.page.id || 2926;
 ...
 * 
 */
var obj7036_onTap_activeActionGroupIndex = -1;
var obj7036_onTap_runningActionsCount = 0;
var obj7036_onTap_loopCount = 0;
...
obj7036_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7036_onTap_activeActionGroupIndex = -1;
		$("#obj7036").trigger("obj7036_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 7036) {
				console.warn("de-queueing event obj7036." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj7036").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj7036_onTap_activeActionGroupIndex = 0;
...
runjs_7040();
function runjs_7040() {
	window.obj7036_onTap_runningActionsCount = obj7036_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj7036_onTap_runningActionsCount = window.obj7036_onTap_runningActionsCount - 1;
if (window.obj7036_onTap_runningActionsCount < 0) {
	window.obj7036_onTap_runningActionsCount = 0;
} else if (window.obj7036_onTap_runningActionsCount == 0) {
	obj7036_onTap_actionGroup1();
}
	}, 1);
}
...
obj7036_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj7036: Event Touch Down
 *
 */
$("#obj7036").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj7036_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj7036_onTap is still running");
	return;
}
var obj7036_onTap_runningActionsCount = 0;
var obj7036_onTap_loopCount = 0;
obj7036_onTap_actionGroup0();
});
...
$("#obj3050").trigger('SCEventShow');
$("#obj3440").trigger('SCEventShow');
$("#obj3342").trigger('SCEventShow');
$("#obj3624").trigger('SCEventShow');
$("#obj3622").trigger('SCEventShow');
$("#obj3632").trigger('SCEventShow');
$("#obj3626").trigger('SCEventShow');
$("#obj7052").trigger('SCEventShow');
$("#obj3442").trigger('SCEventShow');
$("#obj3628").trigger('SCEventShow');
$("#obj3630").trigger('SCEventShow');
$("#obj4040").trigger('SCEventShow');
$("#obj7036").trigger('SCEventShow');
