...
pubcoder.page.id = pubcoder.page.id || 2942;
...
function switchImage_7834() {
	...
	var switchHelperId = "switchHelper407"
	var switchHelperRef = "#switchHelper407"
	var switchId = "407";
	var toSwitchId = "407";
	var fadeDuration = "0s";
...
$("#obj3376").trigger('SCEventShow');
$("#obj3506").trigger('SCEventShow');
$("#obj3116").trigger('SCEventShow');
$("#obj3119").trigger('SCEventShow');
$("#obj3122").trigger('SCEventShow');
$("#obj3508").trigger('SCEventShow');
$("#obj3510").trigger('SCEventShow');
