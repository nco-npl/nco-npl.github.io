...
pubcoder.page.id = pubcoder.page.id || 2944;
...
function switchImage_7828() {
	...
	var switchHelperId = "switchHelper425"
	var switchHelperRef = "#switchHelper425"
	var switchId = "425";
	var toSwitchId = "425";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj3128").trigger('SCEventShow');
$("#obj3380").trigger('SCEventShow');
$("#obj6438").trigger('SCEventShow');
$("#obj6923").trigger('SCEventShow');
$("#obj6440").trigger('SCEventShow');
$("#obj6925").trigger('SCEventShow');
$("#obj6442").trigger('SCEventShow');
$("#obj6927").trigger('SCEventShow');
