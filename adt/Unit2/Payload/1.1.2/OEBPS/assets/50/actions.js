...
pubcoder.page.id = pubcoder.page.id || 2946;
...
var drawerObj3235 = new Drawer('obj3235', {
...
function switchImage_7834() {
	...
	var switchHelperId = "switchHelper464"
	var switchHelperRef = "#switchHelper464"
	var switchId = "464";
	var toSwitchId = "464";
	var fadeDuration = "0s";
...
$("#obj3134").trigger('SCEventShow');
$("#obj3512").trigger('SCEventShow');
$("#obj3384").trigger('SCEventShow');
$("#obj3235").trigger('SCEventShow');
