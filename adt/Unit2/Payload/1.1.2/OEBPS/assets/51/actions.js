...
pubcoder.page.id = pubcoder.page.id || 2947;
...
function switchImage_7834() {
	...
	var switchHelperId = "switchHelper472"
	var switchHelperRef = "#switchHelper472"
	var switchId = "472";
	var toSwitchId = "472";
	var fadeDuration = "0s";
...
$("#obj3140").trigger('SCEventShow');
$("#obj3294").trigger('SCEventShow');
$("#obj3386").trigger('SCEventShow');
$("#obj3730").trigger('SCEventShow');
