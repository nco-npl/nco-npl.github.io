...
pubcoder.page.id = pubcoder.page.id || 2948;
...
function switchImage_7834() {
	...
	var switchHelperId = "switchHelper480"
	var switchHelperRef = "#switchHelper480"
	var switchId = "480";
	var toSwitchId = "480";
	var fadeDuration = "0s";
...
function switchImage_7840() {
	...
	var switchHelperId = "switchHelper481"
	var switchHelperRef = "#switchHelper481"
	var switchId = "481";
	var toSwitchId = "481";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj3143").trigger('SCEventShow');
$("#obj3388").trigger('SCEventShow');
$("#obj3734").trigger('SCEventShow');
$("#obj3514").trigger('SCEventShow');
$("#obj3736").trigger('SCEventShow');
