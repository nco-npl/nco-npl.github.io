...
pubcoder.page.id = pubcoder.page.id || 2903;
 ...
 * 
 */
var obj6990_onTap_activeActionGroupIndex = -1;
var obj6990_onTap_runningActionsCount = 0;
var obj6990_onTap_loopCount = 0;
...
obj6990_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6990_onTap_activeActionGroupIndex = -1;
		$("#obj6990").trigger("obj6990_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 6990) {
				console.warn("de-queueing event obj6990." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj6990").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj6990_onTap_activeActionGroupIndex = 0;
...
runjs_6994();
function runjs_6994() {
	window.obj6990_onTap_runningActionsCount = obj6990_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj6990_onTap_runningActionsCount = window.obj6990_onTap_runningActionsCount - 1;
if (window.obj6990_onTap_runningActionsCount < 0) {
	window.obj6990_onTap_runningActionsCount = 0;
} else if (window.obj6990_onTap_runningActionsCount == 0) {
	obj6990_onTap_actionGroup1();
}
	}, 1);
}
...
obj6990_onTap_actionGroup1 = function(){
...
function switchImage_7834() {
	...
	var switchHelperId = "switchHelper58"
	var switchHelperRef = "#switchHelper58"
	var switchId = "58";
	var toSwitchId = "58";
	var fadeDuration = "0s";
...
function switchImage_7840() {
	...
	var switchHelperId = "switchHelper59"
	var switchHelperRef = "#switchHelper59"
	var switchId = "59";
	var toSwitchId = "59";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_7828() {
	...
	var switchHelperId = "switchHelper60"
	var switchHelperRef = "#switchHelper60"
	var switchId = "60";
	var toSwitchId = "60";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj6990: Event Touch Down
 *
 */
$("#obj6990").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj6990_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj6990_onTap is still running");
	return;
}
var obj6990_onTap_runningActionsCount = 0;
var obj6990_onTap_loopCount = 0;
obj6990_onTap_actionGroup0();
});
...
$("#obj3272").trigger('SCEventShow');
$("#obj7138").trigger('SCEventShow');
$("#obj3552").trigger('SCEventShow');
$("#obj3546").trigger('SCEventShow');
$("#obj3544").trigger('SCEventShow');
$("#obj3550").trigger('SCEventShow');
$("#obj3554").trigger('SCEventShow');
$("#obj3548").trigger('SCEventShow');
$("#obj3994").trigger('SCEventShow');
$("#obj6990").trigger('SCEventShow');
