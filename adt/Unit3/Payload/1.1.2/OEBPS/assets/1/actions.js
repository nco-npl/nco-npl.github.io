 ...
 * 
 */
var obj4072_onTap_activeActionGroupIndex = -1;
var obj4072_onTap_runningActionsCount = 0;
var obj4072_onTap_loopCount = 0;
...
obj4072_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4072_onTap_activeActionGroupIndex = -1;
		$("#obj4072").trigger("obj4072_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4072) {
				console.warn("de-queueing event obj4072." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4072").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4072_onTap_activeActionGroupIndex = 0;
...
runjs_4076();
function runjs_4076() {
	window.obj4072_onTap_runningActionsCount = obj4072_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj4072_onTap_runningActionsCount = window.obj4072_onTap_runningActionsCount - 1;
if (window.obj4072_onTap_runningActionsCount < 0) {
	window.obj4072_onTap_runningActionsCount = 0;
} else if (window.obj4072_onTap_runningActionsCount == 0) {
	obj4072_onTap_actionGroup1();
}
	}, 1);
}
...
obj4072_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj4072: Event Touch Down
 *
 */
$("#obj4072").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4072_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4072_onTap is still running");
	return;
}
var obj4072_onTap_runningActionsCount = 0;
var obj4072_onTap_loopCount = 0;
obj4072_onTap_actionGroup0();
});
