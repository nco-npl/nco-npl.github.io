...
pubcoder.page.id = pubcoder.page.id || 3812;
 ...
 * 
 */
var obj9862_onTap_activeActionGroupIndex = -1;
var obj9862_onTap_runningActionsCount = 0;
var obj9862_onTap_loopCount = 0;
...
obj9862_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9862_onTap_activeActionGroupIndex = -1;
		$("#obj9862").trigger("obj9862_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9862) {
				console.warn("de-queueing event obj9862." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9862").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9862_onTap_activeActionGroupIndex = 0;
...
runjs_9866();
function runjs_9866() {
	window.obj9862_onTap_runningActionsCount = obj9862_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9862_onTap_runningActionsCount = window.obj9862_onTap_runningActionsCount - 1;
if (window.obj9862_onTap_runningActionsCount < 0) {
	window.obj9862_onTap_runningActionsCount = 0;
} else if (window.obj9862_onTap_runningActionsCount == 0) {
	obj9862_onTap_actionGroup1();
}
	}, 1);
}
...
obj9862_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj9862: Event Touch Down
 *
 */
$("#obj9862").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9862_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9862_onTap is still running");
	return;
}
var obj9862_onTap_runningActionsCount = 0;
var obj9862_onTap_loopCount = 0;
obj9862_onTap_actionGroup0();
});
...
$("#obj3907").trigger('SCEventShow');
$("#obj4169").trigger('SCEventShow');
$("#obj4395").trigger('SCEventShow');
...
$("#obj9862").trigger('SCEventShow');
$("#obj4784").trigger('SCEventShow');
