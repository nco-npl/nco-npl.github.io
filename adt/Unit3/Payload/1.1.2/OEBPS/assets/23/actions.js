...
pubcoder.page.id = pubcoder.page.id || 3823;
...
function switchImage_10401() {
	...
	var switchHelperId = "switchHelper288"
	var switchHelperRef = "#switchHelper288"
	var switchId = "288";
	var toSwitchId = "288";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj4469").trigger('SCEventShow');
$("#obj4239").trigger('SCEventShow');
$("#obj4243").trigger('SCEventShow');
$("#obj4471").trigger('SCEventShow');
$("#obj4245").trigger('SCEventShow');
$("#obj4708").trigger('SCEventShow');
$("#obj9897").trigger('SCEventShow');
$("#obj4804").trigger('SCEventShow');
