...
pubcoder.page.id = pubcoder.page.id || 4916;
 ...
 * 
 */
var obj9904_onTap_activeActionGroupIndex = -1;
var obj9904_onTap_runningActionsCount = 0;
var obj9904_onTap_loopCount = 0;
...
obj9904_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9904_onTap_activeActionGroupIndex = -1;
		$("#obj9904").trigger("obj9904_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9904) {
				console.warn("de-queueing event obj9904." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9904").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9904_onTap_activeActionGroupIndex = 0;
...
runjs_9908();
function runjs_9908() {
	window.obj9904_onTap_runningActionsCount = obj9904_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9904_onTap_runningActionsCount = window.obj9904_onTap_runningActionsCount - 1;
if (window.obj9904_onTap_runningActionsCount < 0) {
	window.obj9904_onTap_runningActionsCount = 0;
} else if (window.obj9904_onTap_runningActionsCount == 0) {
	obj9904_onTap_actionGroup1();
}
	}, 1);
}
...
obj9904_onTap_actionGroup1 = function(){
...
function switchImage_10401() {
	...
	var switchHelperId = "switchHelper320"
	var switchHelperRef = "#switchHelper320"
	var switchId = "320";
	var toSwitchId = "320";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj9904: Event Touch Down
 *
 */
$("#obj9904").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9904_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9904_onTap is still running");
	return;
}
var obj9904_onTap_runningActionsCount = 0;
var obj9904_onTap_loopCount = 0;
obj9904_onTap_actionGroup0();
});
...
$("#obj4937").trigger('SCEventShow');
$("#obj4939").trigger('SCEventShow');
$("#obj4934").trigger('SCEventShow');
$("#obj4921").trigger('SCEventShow');
$("#obj9904").trigger('SCEventShow');
$("#obj4923").trigger('SCEventShow');
