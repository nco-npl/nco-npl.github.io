...
pubcoder.page.id = pubcoder.page.id || 3829;
 ...
 * 
 */
var obj9911_onTap_activeActionGroupIndex = -1;
var obj9911_onTap_runningActionsCount = 0;
var obj9911_onTap_loopCount = 0;
...
obj9911_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9911_onTap_activeActionGroupIndex = -1;
		$("#obj9911").trigger("obj9911_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9911) {
				console.warn("de-queueing event obj9911." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9911").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9911_onTap_activeActionGroupIndex = 0;
...
runjs_9915();
function runjs_9915() {
	window.obj9911_onTap_runningActionsCount = obj9911_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9911_onTap_runningActionsCount = window.obj9911_onTap_runningActionsCount - 1;
if (window.obj9911_onTap_runningActionsCount < 0) {
	window.obj9911_onTap_runningActionsCount = 0;
} else if (window.obj9911_onTap_runningActionsCount == 0) {
	obj9911_onTap_actionGroup1();
}
	}, 1);
}
...
obj9911_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj9911: Event Touch Down
 *
 */
$("#obj9911").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9911_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9911_onTap is still running");
	return;
}
var obj9911_onTap_runningActionsCount = 0;
var obj9911_onTap_loopCount = 0;
obj9911_onTap_actionGroup0();
});
...
$("#obj4720").trigger('SCEventShow');
$("#obj9911").trigger('SCEventShow');
$("#obj4816").trigger('SCEventShow');
