...
pubcoder.page.id = pubcoder.page.id || 4967;
...
function switchImage_10395() {
	...
	var switchHelperId = "switchHelper343"
	var switchHelperRef = "#switchHelper343"
	var switchId = "343";
	var toSwitchId = "343";
	var fadeDuration = "0s";
...
function switchImage_10401() {
	...
	var switchHelperId = "switchHelper344"
	var switchHelperRef = "#switchHelper344"
	var switchId = "344";
	var toSwitchId = "344";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj4987").trigger('SCEventShow');
$("#obj4989").trigger('SCEventShow');
$("#obj4974").trigger('SCEventShow');
$("#obj4970").trigger('SCEventShow');
$("#obj4972").trigger('SCEventShow');
