 ...
 * 
 */
var obj5182_onTap_activeActionGroupIndex = -1;
var obj5182_onTap_runningActionsCount = 0;
var obj5182_onTap_loopCount = 0;
var obj5175_onTap_activeActionGroupIndex = -1;
var obj5175_onTap_runningActionsCount = 0;
var obj5175_onTap_loopCount = 0;
var obj10482_onTap_activeActionGroupIndex = -1;
var obj10482_onTap_runningActionsCount = 0;
var obj10482_onTap_loopCount = 0;
var obj10476_onTap_activeActionGroupIndex = -1;
var obj10476_onTap_runningActionsCount = 0;
var obj10476_onTap_loopCount = 0;
var obj9918_onTap_activeActionGroupIndex = -1;
var obj9918_onTap_runningActionsCount = 0;
var obj9918_onTap_loopCount = 0;
...
obj5182_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5182_onTap_activeActionGroupIndex = -1;
		$("#obj5182").trigger("obj5182_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 5182) {
				console.warn("de-queueing event obj5182." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj5182").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj5182_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj5173
(function(){
	window.obj5182_onTap_runningActionsCount = obj5182_onTap_runningActionsCount + 1;

	var selector = "#obj5173";
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				...
				if (isLast) {
					window.obj5182_onTap_runningActionsCount = window.obj5182_onTap_runningActionsCount - 1;
if (window.obj5182_onTap_runningActionsCount < 0) {
	window.obj5182_onTap_runningActionsCount = 0;
} else if (window.obj5182_onTap_runningActionsCount == 0) {
	obj5182_onTap_actionGroup1();
}
				}
...
obj5182_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5182_onTap_activeActionGroupIndex = -1;
		$("#obj5182").trigger("obj5182_onTap_ended");
...
playAudioFile_5187();
function playAudioFile_5187() {
	window.obj5182_onTap_runningActionsCount = obj5182_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile5187")[0];
	...
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile5187");
			$("#obj_audio_playSoundFile5187").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5182_onTap_runningActionsCount = window.obj5182_onTap_runningActionsCount - 1;
if (window.obj5182_onTap_runningActionsCount < 0) {
	window.obj5182_onTap_runningActionsCount = 0;
} else if (window.obj5182_onTap_runningActionsCount == 0) {
	obj5182_onTap_actionGroup2();
}
			});
		} else {
...
obj5182_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5182_onTap_activeActionGroupIndex = -1;
		$("#obj5182").trigger("obj5182_onTap_ended");
	...
	window.obj5182_onTap_activeActionGroupIndex = 2;
	

//	action: hide
//	selector: obj#obj10407 
hide_10409();
function hide_10409() {
	var selector = "#obj10407";
...
obj5182_onTap_actionGroup3 = function(){
	...
	window.obj5182_onTap_activeActionGroupIndex = 3;
...
obj5175_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5175_onTap_activeActionGroupIndex = -1;
		$("#obj5175").trigger("obj5175_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 5175) {
				console.warn("de-queueing event obj5175." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj5175").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj5175_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj10407
(function(){
	window.obj5175_onTap_runningActionsCount = obj5175_onTap_runningActionsCount + 1;
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				$(element).css("display", "block");
				if (isLast) {
					window.obj5175_onTap_runningActionsCount = window.obj5175_onTap_runningActionsCount - 1;
if (window.obj5175_onTap_runningActionsCount < 0) {
	window.obj5175_onTap_runningActionsCount = 0;
} else if (window.obj5175_onTap_runningActionsCount == 0) {
	obj5175_onTap_actionGroup1();
}
				}
				$(element).trigger('SCEventShow');
			}, 1);
...
obj5175_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5175_onTap_activeActionGroupIndex = -1;
		$("#obj5175").trigger("obj5175_onTap_ended");
...
obj5175_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5175_onTap_activeActionGroupIndex = -1;
		$("#obj5175").trigger("obj5175_onTap_ended");
	...
	window.obj5175_onTap_activeActionGroupIndex = 2;
...
//	action: playAudioFile
playAudioFile_5180();
function playAudioFile_5180() {
	window.obj5175_onTap_runningActionsCount = obj5175_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile5180")[0];
	var playFromBeginning = true;
	var waitForCompletion = false;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile5180");
			$("#obj_audio_playSoundFile5180").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5175_onTap_runningActionsCount = window.obj5175_onTap_runningActionsCount - 1;
if (window.obj5175_onTap_runningActionsCount < 0) {
	window.obj5175_onTap_runningActionsCount = 0;
} else if (window.obj5175_onTap_runningActionsCount == 0) {
	obj5175_onTap_actionGroup3();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj5175_onTap_actionGroup3 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj5175_onTap_activeActionGroupIndex = -1;
		$("#obj5175").trigger("obj5175_onTap_ended");
	...
	window.obj5175_onTap_activeActionGroupIndex = 3;
...
obj10482_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj10482_onTap_activeActionGroupIndex = -1;
		$("#obj10482").trigger("obj10482_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 10482) {
				console.warn("de-queueing event obj10482." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj10482").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj10482_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj10487
(function(){
	window.obj10482_onTap_runningActionsCount = obj10482_onTap_runningActionsCount + 1;

	var selector = "#obj10487";
	if ($(selector).hasClass("SCImage")) {
		var lastIndex = $(selector).length-1;
		$(selector).each(function (index, element) {
			if ($(element).hasClass("SCImage")) {
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				$(element).css("display", "block");
				if (isLast) {
					window.obj10482_onTap_runningActionsCount = window.obj10482_onTap_runningActionsCount - 1;
if (window.obj10482_onTap_runningActionsCount < 0) {
	window.obj10482_onTap_runningActionsCount = 0;
} else if (window.obj10482_onTap_runningActionsCount == 0) {
	obj10482_onTap_actionGroup1();
}
				}
				$(element).trigger('SCEventShow');
			}, 1);
...
obj10482_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj10482_onTap_activeActionGroupIndex = -1;
		$("#obj10482").trigger("obj10482_onTap_ended");
...
//	action: playAudioFile
playAudioFile_10485();
function playAudioFile_10485() {
	window.obj10482_onTap_runningActionsCount = obj10482_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10485")[0];
	var playFromBeginning = true;
	var waitForCompletion = false;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10485");
			$("#obj_audio_playSoundFile10485").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj10482_onTap_runningActionsCount = window.obj10482_onTap_runningActionsCount - 1;
if (window.obj10482_onTap_runningActionsCount < 0) {
	window.obj10482_onTap_runningActionsCount = 0;
} else if (window.obj10482_onTap_runningActionsCount == 0) {
	obj10482_onTap_actionGroup2();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj10482_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj10482_onTap_activeActionGroupIndex = -1;
		$("#obj10482").trigger("obj10482_onTap_ended");
	...
	window.obj10482_onTap_activeActionGroupIndex = 2;
	

//	action: hide
//	selector: obj#obj10489 
hide_10486();
function hide_10486() {
	var selector = "#obj10489";
	$(selector).removeClass("animated bounce flash pulse rubberBand shake headShake swing tada wobble jello bounceIn bounceInDown bounceInLeft bounceInRight bounceInUp bounceOut bounceOutDown bounceOutLeft bounceOutRight bounceOutUp fadeIn fadeInDown fadeInDownBig fadeInLeft fadeInLeftBig fadeInRight fadeInRightBig fadeInUp fadeInUpBig fadeOut fadeOutDown fadeOutDownBig fadeOutLeft fadeOutLeftBig fadeOutRight fadeOutRightBig fadeOutUp fadeOutUpBig flipInX flipInY flipOutX flipOutY lightSpeedIn lightSpeedOut rotateIn rotateInDownLeft rotateInDownRight rotateInUpLeft rotateInUpRight rotateOut rotateOutDownLeft rotateOutDownRight rotateOutUpLeft rotateOutUpRight hinge jackInTheBox rollIn rollOut zoomIn zoomInDown zoomInLeft zoomInRight zoomInUp zoomOut zoomOutDown zoomOutLeft zoomOutRight zoomOutUp slideInDown slideInLeft slideInRight slideInUp slideOutDown slideOutLeft slideOutRight slideOutUp heartBeat");
...
obj10482_onTap_actionGroup3 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj10482_onTap_activeActionGroupIndex = -1;
		$("#obj10482").trigger("obj10482_onTap_ended");
	...
	window.obj10482_onTap_activeActionGroupIndex = 3;
...
obj10476_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj10476_onTap_activeActionGroupIndex = -1;
		$("#obj10476").trigger("obj10476_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 10476) {
				console.warn("de-queueing event obj10476." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj10476").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj10476_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj10489
(function(){
	window.obj10476_onTap_runningActionsCount = obj10476_onTap_runningActionsCount + 1;
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				$(element).css("display", "block");
				if (isLast) {
					window.obj10476_onTap_runningActionsCount = window.obj10476_onTap_runningActionsCount - 1;
if (window.obj10476_onTap_runningActionsCount < 0) {
	window.obj10476_onTap_runningActionsCount = 0;
} else if (window.obj10476_onTap_runningActionsCount == 0) {
	obj10476_onTap_actionGroup1();
}
				}
				$(element).trigger('SCEventShow');
			}, 1);
...
obj10476_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj10476_onTap_activeActionGroupIndex = -1;
		$("#obj10476").trigger("obj10476_onTap_ended");
...
obj10476_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj10476_onTap_activeActionGroupIndex = -1;
		$("#obj10476").trigger("obj10476_onTap_ended");
	...
	window.obj10476_onTap_activeActionGroupIndex = 2;
...
//	action: playAudioFile
playAudioFile_10480();
function playAudioFile_10480() {
	window.obj10476_onTap_runningActionsCount = obj10476_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10480")[0];
	var playFromBeginning = true;
	var waitForCompletion = false;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10480");
			$("#obj_audio_playSoundFile10480").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj10476_onTap_runningActionsCount = window.obj10476_onTap_runningActionsCount - 1;
if (window.obj10476_onTap_runningActionsCount < 0) {
	window.obj10476_onTap_runningActionsCount = 0;
} else if (window.obj10476_onTap_runningActionsCount == 0) {
	obj10476_onTap_actionGroup3();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj10476_onTap_actionGroup3 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj10476_onTap_activeActionGroupIndex = -1;
		$("#obj10476").trigger("obj10476_onTap_ended");
	...
	window.obj10476_onTap_activeActionGroupIndex = 3;
...
obj9918_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9918_onTap_activeActionGroupIndex = -1;
		$("#obj9918").trigger("obj9918_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9918) {
				console.warn("de-queueing event obj9918." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9918").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9918_onTap_activeActionGroupIndex = 0;
...
runjs_9922();
function runjs_9922() {
	window.obj9918_onTap_runningActionsCount = obj9918_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9918_onTap_runningActionsCount = window.obj9918_onTap_runningActionsCount - 1;
if (window.obj9918_onTap_runningActionsCount < 0) {
	window.obj9918_onTap_runningActionsCount = 0;
} else if (window.obj9918_onTap_runningActionsCount == 0) {
	obj9918_onTap_actionGroup1();
}
	}, 1);
}
...
obj9918_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj9918_onTap_activeActionGroupIndex = -1;
		$("#obj9918").trigger("obj9918_onTap_ended");
...
function switchImage_10395() {
	...
	var switchHelperId = "switchHelper355"
	var switchHelperRef = "#switchHelper355"
	var switchId = "355";
	var toSwitchId = "355";
	var fadeDuration = "0s";
...
/*
 *
 *   obj5182: Event Touch Down
 *
 */
$("#obj5182").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj5182_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj5182_onTap is still running");
	return;
}
var obj5182_onTap_runningActionsCount = 0;
var obj5182_onTap_loopCount = 0;
obj5182_onTap_actionGroup0();
});
...
/*
 *
 *   obj5175: Event Touch Down
 *
 */
$("#obj5175").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj5175_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj5175_onTap is still running");
	return;
}
var obj5175_onTap_runningActionsCount = 0;
var obj5175_onTap_loopCount = 0;
obj5175_onTap_actionGroup0();
});
...
/*
 *
 *   obj10482: Event Touch Down
 *
 */
$("#obj10482").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj10482_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj10482_onTap is still running");
	return;
}
var obj10482_onTap_runningActionsCount = 0;
var obj10482_onTap_loopCount = 0;
obj10482_onTap_actionGroup0();
});
...
/*
 *
 *   obj10476: Event Touch Down
 *
 */
$("#obj10476").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj10476_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj10476_onTap is still running");
	return;
}
var obj10476_onTap_runningActionsCount = 0;
var obj10476_onTap_loopCount = 0;
obj10476_onTap_actionGroup0();
});
...
/*
 *
 *   obj9918: Event Touch Down
 *
 */
$("#obj9918").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9918_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9918_onTap is still running");
	return;
}
var obj9918_onTap_runningActionsCount = 0;
var obj9918_onTap_loopCount = 0;
obj9918_onTap_actionGroup0();
});
...
$("#obj9968").trigger('SCEventShow');
$("#obj10168").trigger('SCEventShow');
$("#obj4484").trigger('SCEventShow');
$("#obj4486").trigger('SCEventShow');
$("#obj5182").trigger('SCEventShow');
$("#obj5175").trigger('SCEventShow');
$("#obj10482").trigger('SCEventShow');
$("#obj10476").trigger('SCEventShow');
$("#obj4724").trigger('SCEventShow');
$("#obj9918").trigger('SCEventShow');
$("#obj4820").trigger('SCEventShow');
