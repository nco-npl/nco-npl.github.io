...
pubcoder.page.id = pubcoder.page.id || 3834;
...
function switchImage_10395() {
	...
	var switchHelperId = "switchHelper385"
	var switchHelperRef = "#switchHelper385"
	var switchId = "385";
	var toSwitchId = "385";
	var fadeDuration = "0s";
...
function switchImage_10401() {
	...
	var switchHelperId = "switchHelper386"
	var switchHelperRef = "#switchHelper386"
	var switchId = "386";
	var toSwitchId = "386";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_10389() {
	...
	var switchHelperId = "switchHelper387"
	var switchHelperRef = "#switchHelper387"
	var switchId = "387";
	var toSwitchId = "387";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj3970").trigger('SCEventShow');
$("#obj4261").trigger('SCEventShow');
$("#obj4263").trigger('SCEventShow');
$("#obj4500").trigger('SCEventShow');
$("#obj4730").trigger('SCEventShow');
$("#obj4826").trigger('SCEventShow');
