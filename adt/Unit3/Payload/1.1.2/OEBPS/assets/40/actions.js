 ...
 * 
 */
var obj9925_onTap_activeActionGroupIndex = -1;
var obj9925_onTap_runningActionsCount = 0;
var obj9925_onTap_loopCount = 0;
...
obj9925_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9925_onTap_activeActionGroupIndex = -1;
		$("#obj9925").trigger("obj9925_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9925) {
				console.warn("de-queueing event obj9925." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9925").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9925_onTap_activeActionGroupIndex = 0;
...
runjs_9929();
function runjs_9929() {
	window.obj9925_onTap_runningActionsCount = obj9925_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9925_onTap_runningActionsCount = window.obj9925_onTap_runningActionsCount - 1;
if (window.obj9925_onTap_runningActionsCount < 0) {
	window.obj9925_onTap_runningActionsCount = 0;
} else if (window.obj9925_onTap_runningActionsCount == 0) {
	obj9925_onTap_actionGroup1();
}
	}, 1);
}
...
obj9925_onTap_actionGroup1 = function(){
...
function switchImage_10395() {
	...
	var switchHelperId = "switchHelper434"
	var switchHelperRef = "#switchHelper434"
	var switchId = "434";
	var toSwitchId = "434";
	var fadeDuration = "0s";
...
function switchImage_10401() {
	...
	var switchHelperId = "switchHelper435"
	var switchHelperRef = "#switchHelper435"
	var switchId = "435";
	var toSwitchId = "435";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj9925: Event Touch Down
 *
 */
$("#obj9925").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9925_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9925_onTap is still running");
	return;
}
var obj9925_onTap_runningActionsCount = 0;
var obj9925_onTap_loopCount = 0;
obj9925_onTap_actionGroup0();
});
...
$("#obj10054").trigger('SCEventShow');
$("#obj4211").trigger('SCEventShow');
$("#obj4121").trigger('SCEventShow');
$("#obj10057").trigger('SCEventShow');
$("#obj4275").trigger('SCEventShow');
$("#obj4742").trigger('SCEventShow');
$("#obj9925").trigger('SCEventShow');
$("#obj4862").trigger('SCEventShow');
