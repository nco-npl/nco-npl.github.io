 ...
 * 
 */
var obj9932_onTap_activeActionGroupIndex = -1;
var obj9932_onTap_runningActionsCount = 0;
var obj9932_onTap_loopCount = 0;
...
obj9932_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9932_onTap_activeActionGroupIndex = -1;
		$("#obj9932").trigger("obj9932_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9932) {
				console.warn("de-queueing event obj9932." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9932").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9932_onTap_activeActionGroupIndex = 0;
...
runjs_9936();
function runjs_9936() {
	window.obj9932_onTap_runningActionsCount = obj9932_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9932_onTap_runningActionsCount = window.obj9932_onTap_runningActionsCount - 1;
if (window.obj9932_onTap_runningActionsCount < 0) {
	window.obj9932_onTap_runningActionsCount = 0;
} else if (window.obj9932_onTap_runningActionsCount == 0) {
	obj9932_onTap_actionGroup1();
}
	}, 1);
}
...
obj9932_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj9932: Event Touch Down
 *
 */
$("#obj9932").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9932_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9932_onTap is still running");
	return;
}
var obj9932_onTap_runningActionsCount = 0;
var obj9932_onTap_loopCount = 0;
obj9932_onTap_actionGroup0();
});
...
$("#obj10062").trigger('SCEventShow');
$("#obj4283").trigger('SCEventShow');
$("#obj4287").trigger('SCEventShow');
$("#obj10065").trigger('SCEventShow');
$("#obj4656").trigger('SCEventShow');
$("#obj4213").trigger('SCEventShow');
$("#obj4744").trigger('SCEventShow');
$("#obj9932").trigger('SCEventShow');
$("#obj4840").trigger('SCEventShow');
