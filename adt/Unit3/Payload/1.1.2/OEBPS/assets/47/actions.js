...
pubcoder.page.id = pubcoder.page.id || 3847;
...
function switchImage_10395() {
	...
	var switchHelperId = "switchHelper490"
	var switchHelperRef = "#switchHelper490"
	var switchId = "490";
	var toSwitchId = "490";
	var fadeDuration = "0s";
...
function switchImage_10389() {
	...
	var switchHelperId = "switchHelper492"
	var switchHelperRef = "#switchHelper492"
	var switchId = "492";
	var toSwitchId = "492";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj4357").trigger('SCEventShow');
$("#obj4089").trigger('SCEventShow');
$("#obj4756").trigger('SCEventShow');
$("#obj4874").trigger('SCEventShow');
