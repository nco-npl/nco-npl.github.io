 ...
 * 
 */
var obj9350_onTap_activeActionGroupIndex = -1;
var obj9350_onTap_runningActionsCount = 0;
var obj9350_onTap_loopCount = 0;
...
obj9350_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9350_onTap_activeActionGroupIndex = -1;
		$("#obj9350").trigger("obj9350_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9350) {
				console.warn("de-queueing event obj9350." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9350").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9350_onTap_activeActionGroupIndex = 0;
...
runjs_9354();
function runjs_9354() {
	window.obj9350_onTap_runningActionsCount = obj9350_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9350_onTap_runningActionsCount = window.obj9350_onTap_runningActionsCount - 1;
if (window.obj9350_onTap_runningActionsCount < 0) {
	window.obj9350_onTap_runningActionsCount = 0;
} else if (window.obj9350_onTap_runningActionsCount == 0) {
	obj9350_onTap_actionGroup1();
}
	}, 1);
}
...
obj9350_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj9350: Event Touch Down
 *
 */
$("#obj9350").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9350_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9350_onTap is still running");
	return;
}
var obj9350_onTap_runningActionsCount = 0;
var obj9350_onTap_loopCount = 0;
obj9350_onTap_actionGroup0();
});
...
$("#obj4950").trigger('SCEventShow');
$("#obj9350").trigger('SCEventShow');
$("#obj5050").trigger('SCEventShow');
