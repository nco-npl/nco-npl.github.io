 ...
 * 
 */
var obj9341_onTap_activeActionGroupIndex = -1;
var obj9341_onTap_runningActionsCount = 0;
var obj9341_onTap_loopCount = 0;
...
obj9341_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9341_onTap_activeActionGroupIndex = -1;
		$("#obj9341").trigger("obj9341_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9341) {
				console.warn("de-queueing event obj9341." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9341").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9341_onTap_activeActionGroupIndex = 0;
...
runjs_9345();
function runjs_9345() {
	window.obj9341_onTap_runningActionsCount = obj9341_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9341_onTap_runningActionsCount = window.obj9341_onTap_runningActionsCount - 1;
if (window.obj9341_onTap_runningActionsCount < 0) {
	window.obj9341_onTap_runningActionsCount = 0;
} else if (window.obj9341_onTap_runningActionsCount == 0) {
	obj9341_onTap_actionGroup1();
}
	}, 1);
}
...
obj9341_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj9341: Event Touch Down
 *
 */
$("#obj9341").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9341_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9341_onTap is still running");
	return;
}
var obj9341_onTap_runningActionsCount = 0;
var obj9341_onTap_loopCount = 0;
obj9341_onTap_actionGroup0();
});
...
$("#obj4956").trigger('SCEventShow');
$("#obj9341").trigger('SCEventShow');
$("#obj5056").trigger('SCEventShow');
