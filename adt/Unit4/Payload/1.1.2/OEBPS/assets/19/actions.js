...
pubcoder.page.id = pubcoder.page.id || 5226;
...
var obj5231_onTap_activeActionGroupIndex = -1;
var obj5231_onTap_runningActionsCount = 0;
var obj5231_onTap_loopCount = 0;
var obj5235_onTap_activeActionGroupIndex = -1;
var obj5235_onTap_runningActionsCount = 0;
var obj5235_onTap_loopCount = 0;
...
obj5233_onTap_actionGroup0 = function(){
	...
	if (isLastActionGroup) {
		...
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			...
			if (evt.senderObjectId == 5233) {
				console.warn("de-queueing event obj5233." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj5233").trigger(evt.eventName);
				return;
			}
		}
		return;
...
if (window.obj5233_onTap_runningActionsCount < 0) {
	window.obj5233_onTap_runningActionsCount = 0;
} else if (window.obj5233_onTap_runningActionsCount == 0) {
...
playAudioFile_10038();
function playAudioFile_10038() {
	window.obj5233_onTap_runningActionsCount = obj5233_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10038")[0];
	...
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10038");
			$("#obj_audio_playSoundFile10038").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5233_onTap_runningActionsCount = window.obj5233_onTap_runningActionsCount - 1;
if (window.obj5233_onTap_runningActionsCount < 0) {
	window.obj5233_onTap_runningActionsCount = 0;
} else if (window.obj5233_onTap_runningActionsCount == 0) {
	obj5233_onTap_actionGroup2();
}
			});
		} else {
...
obj5233_onTap_actionGroup2 = function(){
	...
	window.obj5233_onTap_activeActionGroupIndex = 2;
...
obj5231_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5231_onTap_activeActionGroupIndex = -1;
		$("#obj5231").trigger("obj5231_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 5231) {
				console.warn("de-queueing event obj5231." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj5231").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj5231_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj5461
(function(){
	window.obj5231_onTap_runningActionsCount = obj5231_onTap_runningActionsCount + 1;
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				$(element).css("display", "block");
				if (isLast) {
					window.obj5231_onTap_runningActionsCount = window.obj5231_onTap_runningActionsCount - 1;
if (window.obj5231_onTap_runningActionsCount < 0) {
	window.obj5231_onTap_runningActionsCount = 0;
} else if (window.obj5231_onTap_runningActionsCount == 0) {
	obj5231_onTap_actionGroup1();
}
				}
				$(element).trigger('SCEventShow');
			}, 1);
...
obj5231_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5231_onTap_activeActionGroupIndex = -1;
		$("#obj5231").trigger("obj5231_onTap_ended");
...
//	action: playAudioFile
playAudioFile_10036();
function playAudioFile_10036() {
	window.obj5231_onTap_runningActionsCount = obj5231_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10036")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10036");
			$("#obj_audio_playSoundFile10036").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5231_onTap_runningActionsCount = window.obj5231_onTap_runningActionsCount - 1;
if (window.obj5231_onTap_runningActionsCount < 0) {
	window.obj5231_onTap_runningActionsCount = 0;
} else if (window.obj5231_onTap_runningActionsCount == 0) {
	obj5231_onTap_actionGroup2();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj5231_onTap_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj5231_onTap_activeActionGroupIndex = -1;
		$("#obj5231").trigger("obj5231_onTap_ended");
	...
	window.obj5231_onTap_activeActionGroupIndex = 2;
...
obj5235_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5235_onTap_activeActionGroupIndex = -1;
		$("#obj5235").trigger("obj5235_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 5235) {
				console.warn("de-queueing event obj5235." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj5235").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj5235_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj5504
(function(){
	window.obj5235_onTap_runningActionsCount = obj5235_onTap_runningActionsCount + 1;

	var selector = "#obj5504";
	if ($(selector).hasClass("SCImage")) {
		var lastIndex = $(selector).length-1;
		$(selector).each(function (index, element) {
			if ($(element).hasClass("SCImage")) {
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				$(element).css("display", "block");
				if (isLast) {
					window.obj5235_onTap_runningActionsCount = window.obj5235_onTap_runningActionsCount - 1;
if (window.obj5235_onTap_runningActionsCount < 0) {
	window.obj5235_onTap_runningActionsCount = 0;
} else if (window.obj5235_onTap_runningActionsCount == 0) {
	obj5235_onTap_actionGroup1();
}
				}
				$(element).trigger('SCEventShow');
			}, 1);
...
obj5235_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5235_onTap_activeActionGroupIndex = -1;
		$("#obj5235").trigger("obj5235_onTap_ended");
...
//	action: playAudioFile
playAudioFile_10040();
function playAudioFile_10040() {
	window.obj5235_onTap_runningActionsCount = obj5235_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10040")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10040");
			$("#obj_audio_playSoundFile10040").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5235_onTap_runningActionsCount = window.obj5235_onTap_runningActionsCount - 1;
if (window.obj5235_onTap_runningActionsCount < 0) {
	window.obj5235_onTap_runningActionsCount = 0;
} else if (window.obj5235_onTap_runningActionsCount == 0) {
	obj5235_onTap_actionGroup2();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj5235_onTap_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj5235_onTap_activeActionGroupIndex = -1;
		$("#obj5235").trigger("obj5235_onTap_ended");
	...
	window.obj5235_onTap_activeActionGroupIndex = 2;
...
function switchImage_10275() {
	...
	var switchHelperId = "switchHelper185"
	var switchHelperRef = "#switchHelper185"
	var switchId = "185";
	var toSwitchId = "185";
	var fadeDuration = "0s";
...
function switchImage_10281() {
	...
	var switchHelperId = "switchHelper186"
	var switchHelperRef = "#switchHelper186"
	var switchId = "186";
	var toSwitchId = "186";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_10269() {
	...
	var switchHelperId = "switchHelper187"
	var switchHelperRef = "#switchHelper187"
	var switchId = "187";
	var toSwitchId = "187";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
 ...
 *
 */
$("#obj5233").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj5233_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj5233_onTap is still running");
	return;
}
var obj5233_onTap_runningActionsCount = 0;
var obj5233_onTap_loopCount = 0;
...
/*
 *
 *   obj5231: Event Touch Down
 *
 */
$("#obj5231").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj5231_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj5231_onTap is still running");
	return;
}
var obj5231_onTap_runningActionsCount = 0;
var obj5231_onTap_loopCount = 0;
obj5231_onTap_actionGroup0();
});
...
/*
 *
 *   obj5235: Event Touch Down
 *
 */
$("#obj5235").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj5235_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj5235_onTap is still running");
	return;
}
var obj5235_onTap_runningActionsCount = 0;
var obj5235_onTap_loopCount = 0;
obj5235_onTap_actionGroup0();
});
...
$("#obj5227").trigger('SCEventShow');
$("#obj5229").trigger('SCEventShow');
$("#obj10030").trigger('SCEventShow');
$("#obj5233").trigger('SCEventShow');
$("#obj5231").trigger('SCEventShow');
$("#obj5235").trigger('SCEventShow');
$("#obj5237").trigger('SCEventShow');
$("#obj5239").trigger('SCEventShow');
