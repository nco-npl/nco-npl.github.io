...
pubcoder.page.id = pubcoder.page.id || 5301;
 ...
 * 
 */
var obj5304_onTap_activeActionGroupIndex = -1;
var obj5304_onTap_runningActionsCount = 0;
var obj5304_onTap_loopCount = 0;
var obj5306_onTap_activeActionGroupIndex = -1;
var obj5306_onTap_runningActionsCount = 0;
var obj5306_onTap_loopCount = 0;
var obj5308_onTap_activeActionGroupIndex = -1;
var obj5308_onTap_runningActionsCount = 0;
var obj5308_onTap_loopCount = 0;
var obj5310_onTap_activeActionGroupIndex = -1;
var obj5310_onTap_runningActionsCount = 0;
var obj5310_onTap_loopCount = 0;
...
obj5304_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5304_onTap_activeActionGroupIndex = -1;
		$("#obj5304").trigger("obj5304_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 5304) {
				console.warn("de-queueing event obj5304." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj5304").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj5304_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj5356
(function(){
	window.obj5304_onTap_runningActionsCount = obj5304_onTap_runningActionsCount + 1;

	var selector = "#obj5356";
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				...
				if (isLast) {
					window.obj5304_onTap_runningActionsCount = window.obj5304_onTap_runningActionsCount - 1;
if (window.obj5304_onTap_runningActionsCount < 0) {
	window.obj5304_onTap_runningActionsCount = 0;
} else if (window.obj5304_onTap_runningActionsCount == 0) {
	obj5304_onTap_actionGroup1();
}
				}
...
obj5304_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5304_onTap_activeActionGroupIndex = -1;
		$("#obj5304").trigger("obj5304_onTap_ended");
...
playAudioFile_10044();
function playAudioFile_10044() {
	window.obj5304_onTap_runningActionsCount = obj5304_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10044")[0];
	...
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10044");
			$("#obj_audio_playSoundFile10044").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5304_onTap_runningActionsCount = window.obj5304_onTap_runningActionsCount - 1;
if (window.obj5304_onTap_runningActionsCount < 0) {
	window.obj5304_onTap_runningActionsCount = 0;
} else if (window.obj5304_onTap_runningActionsCount == 0) {
	obj5304_onTap_actionGroup2();
}
			});
		} else {
...
obj5304_onTap_actionGroup2 = function(){
	...
	window.obj5304_onTap_activeActionGroupIndex = 2;
...
obj5306_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5306_onTap_activeActionGroupIndex = -1;
		$("#obj5306").trigger("obj5306_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 5306) {
				console.warn("de-queueing event obj5306." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj5306").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj5306_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj5414
(function(){
	window.obj5306_onTap_runningActionsCount = obj5306_onTap_runningActionsCount + 1;

	var selector = "#obj5414";
	if ($(selector).hasClass("SCImage")) {
		var lastIndex = $(selector).length-1;
		$(selector).each(function (index, element) {
			if ($(element).hasClass("SCImage")) {
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				$(element).css("display", "block");
				if (isLast) {
					window.obj5306_onTap_runningActionsCount = window.obj5306_onTap_runningActionsCount - 1;
if (window.obj5306_onTap_runningActionsCount < 0) {
	window.obj5306_onTap_runningActionsCount = 0;
} else if (window.obj5306_onTap_runningActionsCount == 0) {
	obj5306_onTap_actionGroup1();
}
				}
				$(element).trigger('SCEventShow');
			}, 1);
...
obj5306_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5306_onTap_activeActionGroupIndex = -1;
		$("#obj5306").trigger("obj5306_onTap_ended");
...
//	action: playAudioFile
playAudioFile_10046();
function playAudioFile_10046() {
	window.obj5306_onTap_runningActionsCount = obj5306_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10046")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10046");
			$("#obj_audio_playSoundFile10046").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5306_onTap_runningActionsCount = window.obj5306_onTap_runningActionsCount - 1;
if (window.obj5306_onTap_runningActionsCount < 0) {
	window.obj5306_onTap_runningActionsCount = 0;
} else if (window.obj5306_onTap_runningActionsCount == 0) {
	obj5306_onTap_actionGroup2();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj5306_onTap_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj5306_onTap_activeActionGroupIndex = -1;
		$("#obj5306").trigger("obj5306_onTap_ended");
	...
	window.obj5306_onTap_activeActionGroupIndex = 2;
...
//	action: playAudioFile
playAudioFile_10048();
function playAudioFile_10048() {
	window.obj5308_onTap_runningActionsCount = obj5308_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10048")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10048");
			$("#obj_audio_playSoundFile10048").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5308_onTap_runningActionsCount = window.obj5308_onTap_runningActionsCount - 1;
if (window.obj5308_onTap_runningActionsCount < 0) {
	window.obj5308_onTap_runningActionsCount = 0;
...
obj5310_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5310_onTap_activeActionGroupIndex = -1;
		$("#obj5310").trigger("obj5310_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 5310) {
				console.warn("de-queueing event obj5310." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj5310").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj5310_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj5444
(function(){
	window.obj5310_onTap_runningActionsCount = obj5310_onTap_runningActionsCount + 1;

	var selector = "#obj5444";
	if ($(selector).hasClass("SCImage")) {
		var lastIndex = $(selector).length-1;
		$(selector).each(function (index, element) {
			if ($(element).hasClass("SCImage")) {
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				$(element).css("display", "block");
				if (isLast) {
					window.obj5310_onTap_runningActionsCount = window.obj5310_onTap_runningActionsCount - 1;
if (window.obj5310_onTap_runningActionsCount < 0) {
	window.obj5310_onTap_runningActionsCount = 0;
} else if (window.obj5310_onTap_runningActionsCount == 0) {
	obj5310_onTap_actionGroup1();
}
				}
				$(element).trigger('SCEventShow');
			}, 1);
...
obj5310_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5310_onTap_activeActionGroupIndex = -1;
		$("#obj5310").trigger("obj5310_onTap_ended");
...
//	action: playAudioFile
playAudioFile_10042();
function playAudioFile_10042() {
	window.obj5310_onTap_runningActionsCount = obj5310_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10042")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10042");
			$("#obj_audio_playSoundFile10042").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5310_onTap_runningActionsCount = window.obj5310_onTap_runningActionsCount - 1;
if (window.obj5310_onTap_runningActionsCount < 0) {
	window.obj5310_onTap_runningActionsCount = 0;
} else if (window.obj5310_onTap_runningActionsCount == 0) {
	obj5310_onTap_actionGroup2();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj5310_onTap_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj5310_onTap_activeActionGroupIndex = -1;
		$("#obj5310").trigger("obj5310_onTap_ended");
	...
	window.obj5310_onTap_activeActionGroupIndex = 2;
...
obj5312_onTap_actionGroup0 = function(){
	...
	if (isLastActionGroup) {
		...
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 5312) {
				console.warn("de-queueing event obj5312." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj5312").trigger(evt.eventName);
				return;
			}
		}
		return;
...
if (window.obj5312_onTap_runningActionsCount < 0) {
	window.obj5312_onTap_runningActionsCount = 0;
} else if (window.obj5312_onTap_runningActionsCount == 0) {
...
//	action: playAudioFile
playAudioFile_10050();
function playAudioFile_10050() {
	window.obj5312_onTap_runningActionsCount = obj5312_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile10050")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile10050");
			$("#obj_audio_playSoundFile10050").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj5312_onTap_runningActionsCount = window.obj5312_onTap_runningActionsCount - 1;
if (window.obj5312_onTap_runningActionsCount < 0) {
	window.obj5312_onTap_runningActionsCount = 0;
...
function switchImage_10275() {
	...
	var switchHelperId = "switchHelper196"
	var switchHelperRef = "#switchHelper196"
	var switchId = "196";
	var toSwitchId = "196";
	var fadeDuration = "0s";
...
function switchImage_10281() {
	...
	var switchHelperId = "switchHelper197"
	var switchHelperRef = "#switchHelper197"
	var switchId = "197";
	var toSwitchId = "197";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_10269() {
	...
	var switchHelperId = "switchHelper198"
	var switchHelperRef = "#switchHelper198"
	var switchId = "198";
	var toSwitchId = "198";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj5304: Event Touch Down
 *
 */
$("#obj5304").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj5304_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj5304_onTap is still running");
	return;
}
var obj5304_onTap_runningActionsCount = 0;
var obj5304_onTap_loopCount = 0;
obj5304_onTap_actionGroup0();
});
...
/*
 *
 *   obj5306: Event Touch Down
 *
 */
$("#obj5306").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj5306_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj5306_onTap is still running");
	return;
}
var obj5306_onTap_runningActionsCount = 0;
var obj5306_onTap_loopCount = 0;
obj5306_onTap_actionGroup0();
});
 ...
 *
 */
$("#obj5308").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
...
/*
 *
 *   obj5310: Event Touch Down
 *
 */
$("#obj5310").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj5310_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj5310_onTap is still running");
	return;
}
var obj5310_onTap_runningActionsCount = 0;
var obj5310_onTap_loopCount = 0;
obj5310_onTap_actionGroup0();
});
 ...
 *
 */
$("#obj5312").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj5312_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj5312_onTap is still running");
	return;
}
var obj5312_onTap_runningActionsCount = 0;
var obj5312_onTap_loopCount = 0;
...
$("#obj5304").trigger('SCEventShow');
$("#obj5306").trigger('SCEventShow');
$("#obj5308").trigger('SCEventShow');
$("#obj5310").trigger('SCEventShow');
$("#obj5312").trigger('SCEventShow');
$("#obj5314").trigger('SCEventShow');
