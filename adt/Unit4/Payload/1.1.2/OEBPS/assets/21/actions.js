...
pubcoder.page.id = pubcoder.page.id || 4729;
...
(function (){
    ...
    {
        "index": "0",
        "text": "(अ) नचिनेको मानिसले दिएको खानेकुरा  खानुहुन्छ  ।",
        "isTrue": false
    },
    {
        "index": "1",
        "text": "(आ)  धारिलो औजार  चलायो भने  काट्छ  ।",
        "isTrue": true
    },
    {
        "index": "2",
        "text": "(इ) सडकको पेटीबाट हिँड्ने बानी राम्रो हो  ।",
        "isTrue": true
    },
    {
        "index": "3",
        "text": "(ई) शौचालयमा खेल्नु  हुँदैन   ।",
        "isTrue": true
    },
    {
        "index": "4",
        "text": "(उ) दायाँ र बायाँ  नहेरी बाटो काट्नुपर्छ  । ",
        "isTrue": false
    }
]
,
			checksum: "0C6A4F4C843CABE7B1447DEF2BD2187E",
			assessmentID: "truefalse4744",
			assessmentCategory: ""
		},
		options: {
...
$("#obj4966").trigger('SCEventShow');
$("#obj5066").trigger('SCEventShow');
...
//   document.addEventListener("DOMContentLoaded", function () {
    ...
    Array.from(document.querySelectorAll(".check-btn")).forEach(btn => {
        console.log("selector udpate");
      btn.textContent = "जाँच गर्नुहोस्"; // Nepali for "Check"
    });
    Array.from(document.querySelectorAll(".reset-btn")).forEach(btn => {
      btn.textContent = "रिसेट गर्नुहोस्"; // Nepali for "Reset"
    });
//   });
});