 ...
 * 
 */
var obj9329_onTap_activeActionGroupIndex = -1;
var obj9329_onTap_runningActionsCount = 0;
var obj9329_onTap_loopCount = 0;
...
obj9329_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9329_onTap_activeActionGroupIndex = -1;
		$("#obj9329").trigger("obj9329_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9329) {
				console.warn("de-queueing event obj9329." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9329").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9329_onTap_activeActionGroupIndex = 0;
...
runjs_9333();
function runjs_9333() {
	window.obj9329_onTap_runningActionsCount = obj9329_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9329_onTap_runningActionsCount = window.obj9329_onTap_runningActionsCount - 1;
if (window.obj9329_onTap_runningActionsCount < 0) {
	window.obj9329_onTap_runningActionsCount = 0;
} else if (window.obj9329_onTap_runningActionsCount == 0) {
	obj9329_onTap_actionGroup1();
}
	}, 1);
}
...
obj9329_onTap_actionGroup1 = function(){
...
function switchImage_10275() {
	...
	var switchHelperId = "switchHelper227"
	var switchHelperRef = "#switchHelper227"
	var switchId = "227";
	var toSwitchId = "227";
	var fadeDuration = "0s";
...
function switchImage_10269() {
	...
	var switchHelperId = "switchHelper229"
	var switchHelperRef = "#switchHelper229"
	var switchId = "229";
	var toSwitchId = "229";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj9329: Event Touch Down
 *
 */
$("#obj9329").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9329_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9329_onTap is still running");
	return;
}
var obj9329_onTap_runningActionsCount = 0;
var obj9329_onTap_loopCount = 0;
obj9329_onTap_actionGroup0();
});
