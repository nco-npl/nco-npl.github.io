 ...
 * 
 */
var obj9336_onTap_activeActionGroupIndex = -1;
var obj9336_onTap_runningActionsCount = 0;
var obj9336_onTap_loopCount = 0;
...
obj9336_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9336_onTap_activeActionGroupIndex = -1;
		$("#obj9336").trigger("obj9336_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9336) {
				console.warn("de-queueing event obj9336." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9336").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9336_onTap_activeActionGroupIndex = 0;
...
runjs_9340();
function runjs_9340() {
	window.obj9336_onTap_runningActionsCount = obj9336_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9336_onTap_runningActionsCount = window.obj9336_onTap_runningActionsCount - 1;
if (window.obj9336_onTap_runningActionsCount < 0) {
	window.obj9336_onTap_runningActionsCount = 0;
} else if (window.obj9336_onTap_runningActionsCount == 0) {
	obj9336_onTap_actionGroup1();
}
	}, 1);
}
...
obj9336_onTap_actionGroup1 = function(){
...
function switchImage_10269() {
	...
	var switchHelperId = "switchHelper245"
	var switchHelperRef = "#switchHelper245"
	var switchId = "245";
	var toSwitchId = "245";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj9336: Event Touch Down
 *
 */
$("#obj9336").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9336_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9336_onTap is still running");
	return;
}
var obj9336_onTap_runningActionsCount = 0;
var obj9336_onTap_loopCount = 0;
obj9336_onTap_actionGroup0();
});
...
$("#obj4976").trigger('SCEventShow');
$("#obj9336").trigger('SCEventShow');
