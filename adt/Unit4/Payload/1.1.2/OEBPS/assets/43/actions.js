...
pubcoder.page.id = pubcoder.page.id || 3840;
 ...
 * 
 */
var obj4626_onTap_activeActionGroupIndex = -1;
var obj4626_onTap_runningActionsCount = 0;
var obj4626_onTap_loopCount = 0;
var obj4628_onTap_activeActionGroupIndex = -1;
var obj4628_onTap_runningActionsCount = 0;
var obj4628_onTap_loopCount = 0;
var obj4630_onTap_activeActionGroupIndex = -1;
var obj4630_onTap_runningActionsCount = 0;
var obj4630_onTap_loopCount = 0;
var obj4632_onTap_activeActionGroupIndex = -1;
var obj4632_onTap_runningActionsCount = 0;
var obj4632_onTap_loopCount = 0;
var obj4636_onTap_activeActionGroupIndex = -1;
var obj4636_onTap_runningActionsCount = 0;
var obj4636_onTap_loopCount = 0;
var obj4634_onTap_activeActionGroupIndex = -1;
var obj4634_onTap_runningActionsCount = 0;
var obj4634_onTap_loopCount = 0;
...
obj4626_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4626_onTap_activeActionGroupIndex = -1;
		$("#obj4626").trigger("obj4626_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4626) {
				console.warn("de-queueing event obj4626." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4626").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4626_onTap_activeActionGroupIndex = 0;
...
//	target: obj4678 
switchImage_5528();
function switchImage_5528() {
	window.obj4626_onTap_runningActionsCount = obj4626_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4678";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4678_img";
	var fromImagePath = "../images/obj4626_image.png";
	var toImagePath = "../images/switch390_to.png";
	var switchHelperId = "switchHelper390"
	var switchHelperRef = "#switchHelper390"
	var switchId = "390";
	var toSwitchId = "390";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage5528_from";
	var toSoundObjectId = "#obj_audio_switchImage5528_to";
	var audioFrom;
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj4626_onTap_runningActionsCount = window.obj4626_onTap_runningActionsCount - 1;
if (window.obj4626_onTap_runningActionsCount < 0) {
	window.obj4626_onTap_runningActionsCount = 0;
} else if (window.obj4626_onTap_runningActionsCount == 0) {
	obj4626_onTap_actionGroup1();
}
			}, 1);
	};
...
obj4626_onTap_actionGroup1 = function(){
...
obj4628_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4628_onTap_activeActionGroupIndex = -1;
		$("#obj4628").trigger("obj4628_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4628) {
				console.warn("de-queueing event obj4628." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4628").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4628_onTap_activeActionGroupIndex = 0;
...
//	target: obj4680 
switchImage_5531();
function switchImage_5531() {
	window.obj4628_onTap_runningActionsCount = obj4628_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4680";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4680_img";
	var fromImagePath = "../images/obj4626_image.png";
	var toImagePath = "../images/switch393_to.png";
	var switchHelperId = "switchHelper393"
	var switchHelperRef = "#switchHelper393"
	var switchId = "393";
	var toSwitchId = "393";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage5531_from";
	var toSoundObjectId = "#obj_audio_switchImage5531_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj4628_onTap_runningActionsCount = window.obj4628_onTap_runningActionsCount - 1;
if (window.obj4628_onTap_runningActionsCount < 0) {
	window.obj4628_onTap_runningActionsCount = 0;
} else if (window.obj4628_onTap_runningActionsCount == 0) {
	obj4628_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj4628_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4628_onTap_activeActionGroupIndex = -1;
		$("#obj4628").trigger("obj4628_onTap_ended");
...
obj4630_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4630_onTap_activeActionGroupIndex = -1;
		$("#obj4630").trigger("obj4630_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4630) {
				console.warn("de-queueing event obj4630." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4630").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4630_onTap_activeActionGroupIndex = 0;
...
//	target: obj4682 
switchImage_5532();
function switchImage_5532() {
	window.obj4630_onTap_runningActionsCount = obj4630_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4682";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4682_img";
	var fromImagePath = "../images/obj4626_image.png";
	var toImagePath = "../images/switch396_to.png";
	var switchHelperId = "switchHelper396"
	var switchHelperRef = "#switchHelper396"
	var switchId = "396";
	var toSwitchId = "396";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage5532_from";
	var toSoundObjectId = "#obj_audio_switchImage5532_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj4630_onTap_runningActionsCount = window.obj4630_onTap_runningActionsCount - 1;
if (window.obj4630_onTap_runningActionsCount < 0) {
	window.obj4630_onTap_runningActionsCount = 0;
} else if (window.obj4630_onTap_runningActionsCount == 0) {
	obj4630_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj4630_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4630_onTap_activeActionGroupIndex = -1;
		$("#obj4630").trigger("obj4630_onTap_ended");
...
obj4632_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4632_onTap_activeActionGroupIndex = -1;
		$("#obj4632").trigger("obj4632_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4632) {
				console.warn("de-queueing event obj4632." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4632").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4632_onTap_activeActionGroupIndex = 0;
...
//	target: obj4688 
switchImage_5533();
function switchImage_5533() {
	window.obj4632_onTap_runningActionsCount = obj4632_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4688";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4688_img";
	var fromImagePath = "../images/obj4632_image.png";
	var toImagePath = "../images/switch390_to.png";
	var switchHelperId = "switchHelper400"
	var switchHelperRef = "#switchHelper400"
	var switchId = "400";
	var toSwitchId = "400";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage5533_from";
	var toSoundObjectId = "#obj_audio_switchImage5533_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj4632_onTap_runningActionsCount = window.obj4632_onTap_runningActionsCount - 1;
if (window.obj4632_onTap_runningActionsCount < 0) {
	window.obj4632_onTap_runningActionsCount = 0;
} else if (window.obj4632_onTap_runningActionsCount == 0) {
	obj4632_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj4632_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4632_onTap_activeActionGroupIndex = -1;
		$("#obj4632").trigger("obj4632_onTap_ended");
...
obj4636_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4636_onTap_activeActionGroupIndex = -1;
		$("#obj4636").trigger("obj4636_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4636) {
				console.warn("de-queueing event obj4636." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4636").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4636_onTap_activeActionGroupIndex = 0;
...
//	target: obj4695 
switchImage_5535();
function switchImage_5535() {
	window.obj4636_onTap_runningActionsCount = obj4636_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4695";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4695_img";
	var fromImagePath = "../images/obj4632_image.png";
	var toImagePath = "../images/switch396_to.png";
	var switchHelperId = "switchHelper403"
	var switchHelperRef = "#switchHelper403"
	var switchId = "403";
	var toSwitchId = "403";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage5535_from";
	var toSoundObjectId = "#obj_audio_switchImage5535_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj4636_onTap_runningActionsCount = window.obj4636_onTap_runningActionsCount - 1;
if (window.obj4636_onTap_runningActionsCount < 0) {
	window.obj4636_onTap_runningActionsCount = 0;
} else if (window.obj4636_onTap_runningActionsCount == 0) {
	obj4636_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj4636_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4636_onTap_activeActionGroupIndex = -1;
		$("#obj4636").trigger("obj4636_onTap_ended");
...
obj4634_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4634_onTap_activeActionGroupIndex = -1;
		$("#obj4634").trigger("obj4634_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4634) {
				console.warn("de-queueing event obj4634." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4634").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4634_onTap_activeActionGroupIndex = 0;
...
//	target: obj4692 
switchImage_5534();
function switchImage_5534() {
	window.obj4634_onTap_runningActionsCount = obj4634_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4692";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4692_img";
	var fromImagePath = "../images/obj4632_image.png";
	var toImagePath = "../images/switch393_to.png";
	...
	var toSwitchId = "406";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage5534_from";
	var toSoundObjectId = "#obj_audio_switchImage5534_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj4634_onTap_runningActionsCount = window.obj4634_onTap_runningActionsCount - 1;
if (window.obj4634_onTap_runningActionsCount < 0) {
	window.obj4634_onTap_runningActionsCount = 0;
} else if (window.obj4634_onTap_runningActionsCount == 0) {
	obj4634_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj4634_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4634_onTap_activeActionGroupIndex = -1;
		$("#obj4634").trigger("obj4634_onTap_ended");
...
function switchImage_10275() {
	...
	var switchHelperId = "switchHelper409"
	var switchHelperRef = "#switchHelper409"
	var switchId = "409";
	var toSwitchId = "409";
	var fadeDuration = "0s";
...
function switchImage_10281() {
	...
	var switchHelperId = "switchHelper410"
	var switchHelperRef = "#switchHelper410"
	var switchId = "410";
	var toSwitchId = "410";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_10269() {
	...
	var switchHelperId = "switchHelper411"
	var switchHelperRef = "#switchHelper411"
	var switchId = "411";
	var toSwitchId = "411";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj4626: Event Touch Down
 *
 */
$("#obj4626").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4626_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4626_onTap is still running");
	return;
}
var obj4626_onTap_runningActionsCount = 0;
var obj4626_onTap_loopCount = 0;
obj4626_onTap_actionGroup0();
});
...
/*
 *
 *   obj4628: Event Touch Down
 *
 */
$("#obj4628").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4628_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4628_onTap is still running");
	return;
}
var obj4628_onTap_runningActionsCount = 0;
var obj4628_onTap_loopCount = 0;
obj4628_onTap_actionGroup0();
});
...
/*
 *
 *   obj4630: Event Touch Down
 *
 */
$("#obj4630").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4630_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4630_onTap is still running");
	return;
}
var obj4630_onTap_runningActionsCount = 0;
var obj4630_onTap_loopCount = 0;
obj4630_onTap_actionGroup0();
});
...
/*
 *
 *   obj4632: Event Touch Down
 *
 */
$("#obj4632").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4632_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4632_onTap is still running");
	return;
}
var obj4632_onTap_runningActionsCount = 0;
var obj4632_onTap_loopCount = 0;
obj4632_onTap_actionGroup0();
});
...
/*
 *
 *   obj4636: Event Touch Down
 *
 */
$("#obj4636").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4636_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4636_onTap is still running");
	return;
}
var obj4636_onTap_runningActionsCount = 0;
var obj4636_onTap_loopCount = 0;
obj4636_onTap_actionGroup0();
});
...
/*
 *
 *   obj4634: Event Touch Down
 *
 */
$("#obj4634").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4634_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4634_onTap is still running");
	return;
}
var obj4634_onTap_runningActionsCount = 0;
var obj4634_onTap_loopCount = 0;
obj4634_onTap_actionGroup0();
});
...
$("#obj4628").trigger('SCEventShow');
$("#obj4630").trigger('SCEventShow');
$("#obj4678").trigger('SCEventShow');
$("#obj4680").trigger('SCEventShow');
$("#obj4682").trigger('SCEventShow');
$("#obj4632").trigger('SCEventShow');
$("#obj4636").trigger('SCEventShow');
$("#obj4634").trigger('SCEventShow');
$("#obj4688").trigger('SCEventShow');
$("#obj4692").trigger('SCEventShow');
$("#obj4695").trigger('SCEventShow');
$("#obj5010").trigger('SCEventShow');
$("#obj5145").trigger('SCEventShow');
