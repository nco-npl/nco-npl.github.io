...
pubcoder.page.id = pubcoder.page.id || 3841;
 ...
 * 
 */
var obj4642_onTap_activeActionGroupIndex = -1;
var obj4642_onTap_runningActionsCount = 0;
var obj4642_onTap_loopCount = 0;
var obj4640_onTap_activeActionGroupIndex = -1;
var obj4640_onTap_runningActionsCount = 0;
var obj4640_onTap_loopCount = 0;
var obj4638_onTap_activeActionGroupIndex = -1;
var obj4638_onTap_runningActionsCount = 0;
var obj4638_onTap_loopCount = 0;
...
obj4642_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4642_onTap_activeActionGroupIndex = -1;
		$("#obj4642").trigger("obj4642_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4642) {
				console.warn("de-queueing event obj4642." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4642").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4642_onTap_activeActionGroupIndex = 0;
...
//	target: obj4705 
switchImage_5538();
function switchImage_5538() {
	window.obj4642_onTap_runningActionsCount = obj4642_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4705";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4705_img";
	var fromImagePath = "../images/obj4632_image.png";
	var toImagePath = "../images/switch416_to.png";
	var switchHelperId = "switchHelper416"
	var switchHelperRef = "#switchHelper416"
	var switchId = "416";
	var toSwitchId = "416";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage5538_from";
	var toSoundObjectId = "#obj_audio_switchImage5538_to";
	var audioFrom;
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj4642_onTap_runningActionsCount = window.obj4642_onTap_runningActionsCount - 1;
if (window.obj4642_onTap_runningActionsCount < 0) {
	window.obj4642_onTap_runningActionsCount = 0;
} else if (window.obj4642_onTap_runningActionsCount == 0) {
	obj4642_onTap_actionGroup1();
}
			}, 1);
	};
...
obj4642_onTap_actionGroup1 = function(){
...
obj4640_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4640_onTap_activeActionGroupIndex = -1;
		$("#obj4640").trigger("obj4640_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4640) {
				console.warn("de-queueing event obj4640." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4640").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4640_onTap_activeActionGroupIndex = 0;
...
//	target: obj4702 
switchImage_5537();
function switchImage_5537() {
	window.obj4640_onTap_runningActionsCount = obj4640_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4702";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4702_img";
	var fromImagePath = "../images/obj4632_image.png";
	var toImagePath = "../images/switch393_to.png";
	var switchHelperId = "switchHelper419"
	var switchHelperRef = "#switchHelper419"
	var switchId = "419";
	var toSwitchId = "419";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage5537_from";
	var toSoundObjectId = "#obj_audio_switchImage5537_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj4640_onTap_runningActionsCount = window.obj4640_onTap_runningActionsCount - 1;
if (window.obj4640_onTap_runningActionsCount < 0) {
	window.obj4640_onTap_runningActionsCount = 0;
} else if (window.obj4640_onTap_runningActionsCount == 0) {
	obj4640_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj4640_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4640_onTap_activeActionGroupIndex = -1;
		$("#obj4640").trigger("obj4640_onTap_ended");
...
obj4638_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4638_onTap_activeActionGroupIndex = -1;
		$("#obj4638").trigger("obj4638_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 4638) {
				console.warn("de-queueing event obj4638." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj4638").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj4638_onTap_activeActionGroupIndex = 0;
...
//	target: obj4698 
switchImage_5536();
function switchImage_5536() {
	window.obj4638_onTap_runningActionsCount = obj4638_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4698";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4698_img";
	var fromImagePath = "../images/obj4632_image.png";
	var toImagePath = "../images/switch422_to.png";
	var switchHelperId = "switchHelper422"
	var switchHelperRef = "#switchHelper422"
	var switchId = "422";
	var toSwitchId = "422";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage5536_from";
	var toSoundObjectId = "#obj_audio_switchImage5536_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj4638_onTap_runningActionsCount = window.obj4638_onTap_runningActionsCount - 1;
if (window.obj4638_onTap_runningActionsCount < 0) {
	window.obj4638_onTap_runningActionsCount = 0;
} else if (window.obj4638_onTap_runningActionsCount == 0) {
	obj4638_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj4638_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4638_onTap_activeActionGroupIndex = -1;
		$("#obj4638").trigger("obj4638_onTap_ended");
...
function switchImage_10275() {
	...
	var switchHelperId = "switchHelper426"
	var switchHelperRef = "#switchHelper426"
	var switchId = "426";
	var toSwitchId = "426";
	var fadeDuration = "0s";
...
function switchImage_10281() {
	...
	var switchHelperId = "switchHelper427"
	var switchHelperRef = "#switchHelper427"
	var switchId = "427";
	var toSwitchId = "427";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_10269() {
	...
	var switchHelperId = "switchHelper428"
	var switchHelperRef = "#switchHelper428"
	var switchId = "428";
	var toSwitchId = "428";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj4642: Event Touch Down
 *
 */
$("#obj4642").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4642_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4642_onTap is still running");
	return;
}
var obj4642_onTap_runningActionsCount = 0;
var obj4642_onTap_loopCount = 0;
obj4642_onTap_actionGroup0();
});
...
/*
 *
 *   obj4640: Event Touch Down
 *
 */
$("#obj4640").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4640_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4640_onTap is still running");
	return;
}
var obj4640_onTap_runningActionsCount = 0;
var obj4640_onTap_loopCount = 0;
obj4640_onTap_actionGroup0();
});
...
/*
 *
 *   obj4638: Event Touch Down
 *
 */
$("#obj4638").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj4638_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj4638_onTap is still running");
	return;
}
var obj4638_onTap_runningActionsCount = 0;
var obj4638_onTap_loopCount = 0;
obj4638_onTap_actionGroup0();
});
...
$("#obj9458").trigger('SCEventShow');
$("#obj9460").trigger('SCEventShow');
$("#obj9462").trigger('SCEventShow');
$("#obj4013").trigger('SCEventShow');
$("#obj4642").trigger('SCEventShow');
$("#obj4640").trigger('SCEventShow');
$("#obj4638").trigger('SCEventShow');
$("#obj4698").trigger('SCEventShow');
$("#obj4702").trigger('SCEventShow');
$("#obj4705").trigger('SCEventShow');
$("#obj5012").trigger('SCEventShow');
$("#obj5147").trigger('SCEventShow');
