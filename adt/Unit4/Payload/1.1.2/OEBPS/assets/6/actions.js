 ...
 * 
 */
var obj9278_onTap_activeActionGroupIndex = -1;
var obj9278_onTap_runningActionsCount = 0;
var obj9278_onTap_loopCount = 0;
...
obj9278_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9278_onTap_activeActionGroupIndex = -1;
		$("#obj9278").trigger("obj9278_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9278) {
				console.warn("de-queueing event obj9278." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9278").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9278_onTap_activeActionGroupIndex = 0;
...
runjs_9282();
function runjs_9282() {
	window.obj9278_onTap_runningActionsCount = obj9278_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9278_onTap_runningActionsCount = window.obj9278_onTap_runningActionsCount - 1;
if (window.obj9278_onTap_runningActionsCount < 0) {
	window.obj9278_onTap_runningActionsCount = 0;
} else if (window.obj9278_onTap_runningActionsCount == 0) {
	obj9278_onTap_actionGroup1();
}
	}, 1);
}
...
obj9278_onTap_actionGroup1 = function(){
 ...
 *
 */
$("#obj9278").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9278_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9278_onTap is still running");
	return;
}
var obj9278_onTap_runningActionsCount = 0;
var obj9278_onTap_loopCount = 0;
obj9278_onTap_actionGroup0();
});
...
$("#obj4286").trigger('SCEventShow');
$("#obj4936").trigger('SCEventShow');
$("#obj9278").trigger('SCEventShow');
$("#obj5036").trigger('SCEventShow');
