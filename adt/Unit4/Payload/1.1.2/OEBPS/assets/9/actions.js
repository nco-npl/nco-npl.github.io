 ...
 * 
 */
var obj9294_onTap_activeActionGroupIndex = -1;
var obj9294_onTap_runningActionsCount = 0;
var obj9294_onTap_loopCount = 0;
...
obj9294_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9294_onTap_activeActionGroupIndex = -1;
		$("#obj9294").trigger("obj9294_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9294) {
				console.warn("de-queueing event obj9294." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9294").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9294_onTap_activeActionGroupIndex = 0;
...
runjs_9298();
function runjs_9298() {
	window.obj9294_onTap_runningActionsCount = obj9294_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9294_onTap_runningActionsCount = window.obj9294_onTap_runningActionsCount - 1;
if (window.obj9294_onTap_runningActionsCount < 0) {
	window.obj9294_onTap_runningActionsCount = 0;
} else if (window.obj9294_onTap_runningActionsCount == 0) {
	obj9294_onTap_actionGroup1();
}
	}, 1);
}
...
obj9294_onTap_actionGroup1 = function(){
 ...
 *
 */
$("#obj9294").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9294_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9294_onTap is still running");
	return;
}
var obj9294_onTap_runningActionsCount = 0;
var obj9294_onTap_loopCount = 0;
obj9294_onTap_actionGroup0();
});
