...
pubcoder.page.id = pubcoder.page.id || 8213;
 ...
 * 
 */
var obj8691_onTap_activeActionGroupIndex = -1;
var obj8691_onTap_runningActionsCount = 0;
var obj8691_onTap_loopCount = 0;
...
obj8691_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj8691_onTap_activeActionGroupIndex = -1;
		$("#obj8691").trigger("obj8691_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 8691) {
				console.warn("de-queueing event obj8691." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj8691").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj8691_onTap_activeActionGroupIndex = 0;
...
runjs_8695();
function runjs_8695() {
	window.obj8691_onTap_runningActionsCount = obj8691_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj8691_onTap_runningActionsCount = window.obj8691_onTap_runningActionsCount - 1;
if (window.obj8691_onTap_runningActionsCount < 0) {
	window.obj8691_onTap_runningActionsCount = 0;
} else if (window.obj8691_onTap_runningActionsCount == 0) {
	obj8691_onTap_actionGroup1();
}
	}, 1);
}
...
obj8691_onTap_actionGroup1 = function(){
...
function switchImage_10362() {
	...
	var switchHelperId = "switchHelper32"
	var switchHelperRef = "#switchHelper32"
	var switchId = "32";
	var toSwitchId = "32";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj8691: Event Touch Down
 *
 */
$("#obj8691").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj8691_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj8691_onTap is still running");
	return;
}
var obj8691_onTap_runningActionsCount = 0;
var obj8691_onTap_loopCount = 0;
obj8691_onTap_actionGroup0();
});
...
$("#obj8227").trigger('SCEventShow');
$("#obj8229").trigger('SCEventShow');
$("#obj8216").trigger('SCEventShow');
$("#obj8214").trigger('SCEventShow');
$("#obj8691").trigger('SCEventShow');
$("#obj8218").trigger('SCEventShow');
