...
pubcoder.project.title = pubcoder.project.title || "हाम्रो सेरोफेरो - विषयक्षेत्र ५";
pubcoder.page.id = pubcoder.page.id || 8726;
 ...
 * 
 */
var obj8769_onTap_activeActionGroupIndex = -1;
var obj8769_onTap_runningActionsCount = 0;
var obj8769_onTap_loopCount = 0;
...
var obj10783_onTap_activeActionGroupIndex = -1;
var obj10783_onTap_runningActionsCount = 0;
var obj10783_onTap_loopCount = 0;
...
obj8769_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj8769_onTap_activeActionGroupIndex = -1;
		$("#obj8769").trigger("obj8769_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 8769) {
				console.warn("de-queueing event obj8769." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj8769").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj8769_onTap_activeActionGroupIndex = 0;
...
runjs_8773();
function runjs_8773() {
	window.obj8769_onTap_runningActionsCount = obj8769_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj8769_onTap_runningActionsCount = window.obj8769_onTap_runningActionsCount - 1;
if (window.obj8769_onTap_runningActionsCount < 0) {
	window.obj8769_onTap_runningActionsCount = 0;
} else if (window.obj8769_onTap_runningActionsCount == 0) {
	obj8769_onTap_actionGroup1();
}
	}, 1);
}
...
obj8769_onTap_actionGroup1 = function(){
...
function switchImage_10374() {
	...
	var switchHelperId = "switchHelper111"
	var switchHelperRef = "#switchHelper111"
	var switchId = "111";
	var toSwitchId = "111";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_10362() {
	...
	var switchHelperId = "switchHelper112"
	var switchHelperRef = "#switchHelper112"
	var switchId = "112";
	var toSwitchId = "112";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
obj10783_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj10783_onTap_activeActionGroupIndex = -1;
		$("#obj10783").trigger("obj10783_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 10783) {
				console.warn("de-queueing event obj10783." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj10783").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj10783_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
goToPage_10785();
function goToPage_10785() {
	window.obj10783_onTap_runningActionsCount = obj10783_onTap_runningActionsCount + 1;
	$("#anchor114")[0].click();
	window.obj10783_onTap_runningActionsCount = window.obj10783_onTap_runningActionsCount - 1;
if (window.obj10783_onTap_runningActionsCount < 0) {
	window.obj10783_onTap_runningActionsCount = 0;
} else if (window.obj10783_onTap_runningActionsCount == 0) {
	obj10783_onTap_actionGroup1();
}
}
...
obj10783_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj10783_onTap_activeActionGroupIndex = -1;
		$("#obj10783").trigger("obj10783_onTap_ended");
...
/*
 *
 *   obj8769: Event Touch Down
 *
 */
$("#obj8769").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj8769_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj8769_onTap is still running");
	return;
}
var obj8769_onTap_runningActionsCount = 0;
var obj8769_onTap_loopCount = 0;
obj8769_onTap_actionGroup0();
});
...
/*
 *
 *   obj10783: Event Touch Down
 *
 */
$("#obj10783").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj10783_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj10783_onTap is still running");
	return;
}
var obj10783_onTap_runningActionsCount = 0;
var obj10783_onTap_loopCount = 0;
obj10783_onTap_actionGroup0();
});
...
$("#obj8775").trigger('SCEventShow');
$("#obj8735").trigger('SCEventShow');
$("#obj8763").trigger('SCEventShow');
$("#obj8820").trigger('SCEventShow');
$("#obj8737").trigger('SCEventShow');
$("#obj8778").trigger('SCEventShow');
$("#obj8781").trigger('SCEventShow');
$("#obj8798").trigger('SCEventShow');
$("#obj8761").trigger('SCEventShow');
$("#obj8800").trigger('SCEventShow');
$("#obj8739").trigger('SCEventShow');
$("#obj8818").trigger('SCEventShow');
$("#obj8759").trigger('SCEventShow');
$("#obj8806").trigger('SCEventShow');
$("#obj8757").trigger('SCEventShow');
$("#obj8804").trigger('SCEventShow');
$("#obj8802").trigger('SCEventShow');
$("#obj8755").trigger('SCEventShow');
$("#obj8808").trigger('SCEventShow');
$("#obj8810").trigger('SCEventShow');
$("#obj8753").trigger('SCEventShow');
$("#obj8751").trigger('SCEventShow');
$("#obj8749").trigger('SCEventShow');
$("#obj8812").trigger('SCEventShow');
$("#obj8814").trigger('SCEventShow');
$("#obj8741").trigger('SCEventShow');
$("#obj8747").trigger('SCEventShow');
$("#obj8816").trigger('SCEventShow');
$("#obj8743").trigger('SCEventShow');
$("#obj8745").trigger('SCEventShow');
$("#obj8727").trigger('SCEventShow');
$("#obj8769").trigger('SCEventShow');
$("#obj8731").trigger('SCEventShow');
$("#obj10364").trigger('SCEventShow');
$("#obj10335").trigger('SCEventShow');
$("#obj10780").trigger('SCEventShow');
$("#obj10783").trigger('SCEventShow');
