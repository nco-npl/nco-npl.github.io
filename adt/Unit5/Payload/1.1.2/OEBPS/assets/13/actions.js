 ...
 * 
 */
var obj8721_onTap_activeActionGroupIndex = -1;
var obj8721_onTap_runningActionsCount = 0;
var obj8721_onTap_loopCount = 0;
...
var drawerObj8511 = new Drawer('obj8511', {
...
obj8721_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj8721_onTap_activeActionGroupIndex = -1;
		$("#obj8721").trigger("obj8721_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 8721) {
				console.warn("de-queueing event obj8721." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj8721").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj8721_onTap_activeActionGroupIndex = 0;
...
runjs_8725();
function runjs_8725() {
	window.obj8721_onTap_runningActionsCount = obj8721_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj8721_onTap_runningActionsCount = window.obj8721_onTap_runningActionsCount - 1;
if (window.obj8721_onTap_runningActionsCount < 0) {
	window.obj8721_onTap_runningActionsCount = 0;
} else if (window.obj8721_onTap_runningActionsCount == 0) {
	obj8721_onTap_actionGroup1();
}
	}, 1);
}
...
obj8721_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj8721: Event Touch Down
 *
 */
$("#obj8721").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj8721_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj8721_onTap is still running");
	return;
}
var obj8721_onTap_runningActionsCount = 0;
var obj8721_onTap_loopCount = 0;
obj8721_onTap_actionGroup0();
});
...
$("#obj9625").trigger('SCEventShow');
$("#obj8511").trigger('SCEventShow');
$("#obj8201").trigger('SCEventShow');
$("#obj4060").trigger('SCEventShow');
$("#obj8721").trigger('SCEventShow');
