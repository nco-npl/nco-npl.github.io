...
pubcoder.page.id = pubcoder.page.id || 8420;
 ...
 * 
 */
var obj8698_onTap_activeActionGroupIndex = -1;
var obj8698_onTap_runningActionsCount = 0;
var obj8698_onTap_loopCount = 0;
...
obj8698_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj8698_onTap_activeActionGroupIndex = -1;
		$("#obj8698").trigger("obj8698_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 8698) {
				console.warn("de-queueing event obj8698." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj8698").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj8698_onTap_activeActionGroupIndex = 0;
...
runjs_8702();
function runjs_8702() {
	window.obj8698_onTap_runningActionsCount = obj8698_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj8698_onTap_runningActionsCount = window.obj8698_onTap_runningActionsCount - 1;
if (window.obj8698_onTap_runningActionsCount < 0) {
	window.obj8698_onTap_runningActionsCount = 0;
} else if (window.obj8698_onTap_runningActionsCount == 0) {
	obj8698_onTap_actionGroup1();
}
	}, 1);
}
...
obj8698_onTap_actionGroup1 = function(){
...
function switchImage_10362() {
	...
	var switchHelperId = "switchHelper88"
	var switchHelperRef = "#switchHelper88"
	var switchId = "88";
	var toSwitchId = "88";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj8698: Event Touch Down
 *
 */
$("#obj8698").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj8698_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj8698_onTap is still running");
	return;
}
var obj8698_onTap_runningActionsCount = 0;
var obj8698_onTap_loopCount = 0;
obj8698_onTap_actionGroup0();
});
...
$("#obj8425").trigger('SCEventShow');
$("#obj8429").trigger('SCEventShow');
$("#obj8433").trigger('SCEventShow');
$("#obj8437").trigger('SCEventShow');
$("#obj8431").trigger('SCEventShow');
$("#obj8439").trigger('SCEventShow');
$("#obj8423").trigger('SCEventShow');
$("#obj8698").trigger('SCEventShow');
$("#obj8427").trigger('SCEventShow');
