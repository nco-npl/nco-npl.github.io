 ...
 * 
 */
var obj8705_onTap_activeActionGroupIndex = -1;
var obj8705_onTap_runningActionsCount = 0;
var obj8705_onTap_loopCount = 0;
...
obj8705_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj8705_onTap_activeActionGroupIndex = -1;
		$("#obj8705").trigger("obj8705_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 8705) {
				console.warn("de-queueing event obj8705." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj8705").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj8705_onTap_activeActionGroupIndex = 0;
...
runjs_8709();
function runjs_8709() {
	window.obj8705_onTap_runningActionsCount = obj8705_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj8705_onTap_runningActionsCount = window.obj8705_onTap_runningActionsCount - 1;
if (window.obj8705_onTap_runningActionsCount < 0) {
	window.obj8705_onTap_runningActionsCount = 0;
} else if (window.obj8705_onTap_runningActionsCount == 0) {
	obj8705_onTap_actionGroup1();
}
	}, 1);
}
...
obj8705_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj8705: Event Touch Down
 *
 */
$("#obj8705").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj8705_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj8705_onTap is still running");
	return;
}
var obj8705_onTap_runningActionsCount = 0;
var obj8705_onTap_loopCount = 0;
obj8705_onTap_actionGroup0();
});
...
$("#obj8442").trigger('SCEventShow');
$("#obj8450").trigger('SCEventShow');
$("#obj8448").trigger('SCEventShow');
$("#obj8454").trigger('SCEventShow');
$("#obj8444").trigger('SCEventShow');
$("#obj8705").trigger('SCEventShow');
$("#obj8446").trigger('SCEventShow');
