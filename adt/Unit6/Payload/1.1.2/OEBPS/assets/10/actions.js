...
pubcoder.page.id = pubcoder.page.id || 10713;
 ...
 * 
 */
var obj10730_onTap_activeActionGroupIndex = -1;
var obj10730_onTap_runningActionsCount = 0;
var obj10730_onTap_loopCount = 0;
...
var drawerObj10735 = new Drawer('obj10735', {
...
obj10730_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj10730_onTap_activeActionGroupIndex = -1;
		$("#obj10730").trigger("obj10730_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 10730) {
				console.warn("de-queueing event obj10730." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj10730").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj10730_onTap_activeActionGroupIndex = 0;
...
function runjs_10734() {
	window.obj10730_onTap_runningActionsCount = obj10730_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj10730_onTap_runningActionsCount = window.obj10730_onTap_runningActionsCount - 1;
if (window.obj10730_onTap_runningActionsCount < 0) {
	window.obj10730_onTap_runningActionsCount = 0;
} else if (window.obj10730_onTap_runningActionsCount == 0) {
	obj10730_onTap_actionGroup1();
}
	}, 1);
}
...
obj10730_onTap_actionGroup1 = function(){
...
function switchImage_14057() {
	...
	var switchHelperId = "switchHelper144"
	var switchHelperRef = "#switchHelper144"
	var switchId = "144";
	var toSwitchId = "144";
	var fadeDuration = "0s";
...
function switchImage_14051() {
	...
	var switchHelperId = "switchHelper146"
	var switchHelperRef = "#switchHelper146"
	var switchId = "146";
	var toSwitchId = "146";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj10730: Event Touch Down
 *
 */
$("#obj10730").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj10730_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj10730_onTap is still running");
	return;
}
var obj10730_onTap_runningActionsCount = 0;
var obj10730_onTap_loopCount = 0;
obj10730_onTap_actionGroup0();
});
...
$("#obj10716").trigger('SCEventShow');
$("#obj10724").trigger('SCEventShow');
$("#obj10722").trigger('SCEventShow');
$("#obj10735").trigger('SCEventShow');
$("#obj10718").trigger('SCEventShow');
$("#obj10730").trigger('SCEventShow');
