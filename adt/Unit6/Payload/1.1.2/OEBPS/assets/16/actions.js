 ...
 * 
 */
var obj10692_onTap_activeActionGroupIndex = -1;
var obj10692_onTap_runningActionsCount = 0;
var obj10692_onTap_loopCount = 0;
...
obj10692_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj10692_onTap_activeActionGroupIndex = -1;
		$("#obj10692").trigger("obj10692_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 10692) {
				console.warn("de-queueing event obj10692." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj10692").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj10692_onTap_activeActionGroupIndex = 0;
...
runjs_10696();
function runjs_10696() {
	window.obj10692_onTap_runningActionsCount = obj10692_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj10692_onTap_runningActionsCount = window.obj10692_onTap_runningActionsCount - 1;
if (window.obj10692_onTap_runningActionsCount < 0) {
	window.obj10692_onTap_runningActionsCount = 0;
} else if (window.obj10692_onTap_runningActionsCount == 0) {
	obj10692_onTap_actionGroup1();
}
	}, 1);
}
...
obj10692_onTap_actionGroup1 = function(){
...
function switchImage_14051() {
	...
	var switchHelperId = "switchHelper208"
	var switchHelperRef = "#switchHelper208"
	var switchId = "208";
	var toSwitchId = "208";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj10692: Event Touch Down
 *
 */
$("#obj10692").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj10692_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj10692_onTap is still running");
	return;
}
var obj10692_onTap_runningActionsCount = 0;
var obj10692_onTap_loopCount = 0;
obj10692_onTap_actionGroup0();
});
...
$("#obj10041").trigger('SCEventShow');
$("#obj4256").trigger('SCEventShow');
$("#obj10692").trigger('SCEventShow');
$("#obj4296").trigger('SCEventShow');
