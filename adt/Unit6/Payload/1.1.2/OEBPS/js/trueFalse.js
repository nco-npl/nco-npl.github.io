  ...
  const setupDOM = function() {
    ...
    _(statementsIndexes).each(function(statementI, index) {
      ...
      if (statement) {
        ...
        labelTrue.innerHTML = '<label id="' + self.objectId + "_" + index + "_label_true" + '"><span>' + self.config.options.labelTrue + '</span></label>';
        ...
        trueRadio.setAttribute("aria-labelledby", self.objectId + "_" + index + "_label_true");
        ...
        labelFalse.innerHTML = '<label id="' + self.objectId + "_" + index + "_label_false" + '"><span>' + self.config.options.labelFalse + '</span></label>';
        ...
        falseRadio.setAttribute("aria-labelledby", self.objectId + "_" + index + "_label_false");
