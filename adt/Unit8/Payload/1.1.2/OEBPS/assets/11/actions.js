...
pubcoder.page.id = pubcoder.page.id || 8684;
...
function switchImage_12434() {
	...
	var switchHelperId = "switchHelper119"
	var switchHelperRef = "#switchHelper119"
	var switchId = "119";
	var toSwitchId = "119";
	var fadeDuration = "0s";
...
function switchImage_12428() {
	...
	var switchHelperId = "switchHelper121"
	var switchHelperRef = "#switchHelper121"
	var switchId = "121";
	var toSwitchId = "121";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj8722").trigger('SCEventShow');
$("#obj8724").trigger('SCEventShow');
$("#obj8726").trigger('SCEventShow');
$("#obj8719").trigger('SCEventShow');
$("#obj8713").trigger('SCEventShow');
$("#obj8715").trigger('SCEventShow');
