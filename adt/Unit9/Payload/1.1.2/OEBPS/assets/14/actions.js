 ...
 * 
 */
var obj9897_onTap_activeActionGroupIndex = -1;
var obj9897_onTap_runningActionsCount = 0;
var obj9897_onTap_loopCount = 0;
...
obj9897_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9897_onTap_activeActionGroupIndex = -1;
		$("#obj9897").trigger("obj9897_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9897) {
				console.warn("de-queueing event obj9897." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9897").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9897_onTap_activeActionGroupIndex = 0;
...
runjs_9901();
function runjs_9901() {
	window.obj9897_onTap_runningActionsCount = obj9897_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9897_onTap_runningActionsCount = window.obj9897_onTap_runningActionsCount - 1;
if (window.obj9897_onTap_runningActionsCount < 0) {
	window.obj9897_onTap_runningActionsCount = 0;
} else if (window.obj9897_onTap_runningActionsCount == 0) {
	obj9897_onTap_actionGroup1();
}
	}, 1);
}
...
obj9897_onTap_actionGroup1 = function(){
...
function switchImage_11698() {
	...
	var switchHelperId = "switchHelper149"
	var switchHelperRef = "#switchHelper149"
	var switchId = "149";
	var toSwitchId = "149";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj9897: Event Touch Down
 *
 */
$("#obj9897").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9897_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9897_onTap is still running");
	return;
}
var obj9897_onTap_runningActionsCount = 0;
var obj9897_onTap_loopCount = 0;
obj9897_onTap_actionGroup0();
});
...
$("#obj3978").trigger('SCEventShow');
$("#obj4340").trigger('SCEventShow');
$("#obj4338").trigger('SCEventShow');
$("#obj4348").trigger('SCEventShow');
$("#obj4342").trigger('SCEventShow');
$("#obj4350").trigger('SCEventShow');
$("#obj4346").trigger('SCEventShow');
$("#obj4089").trigger('SCEventShow');
$("#obj9897").trigger('SCEventShow');
$("#obj9032").trigger('SCEventShow');
