...
pubcoder.page.id = pubcoder.page.id || 3986;
...
function switchImage_11692() {
	...
	var switchHelperId = "switchHelper178"
	var switchHelperRef = "#switchHelper178"
	var switchId = "178";
	var toSwitchId = "178";
	var fadeDuration = "0s";
...
function switchImage_11698() {
	...
	var switchHelperId = "switchHelper179"
	var switchHelperRef = "#switchHelper179"
	var switchId = "179";
	var toSwitchId = "179";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_11686() {
	...
	var switchHelperId = "switchHelper180"
	var switchHelperRef = "#switchHelper180"
	var switchId = "180";
	var toSwitchId = "180";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj9236").trigger('SCEventShow');
$("#obj9232").trigger('SCEventShow');
$("#obj9238").trigger('SCEventShow');
$("#obj4095").trigger('SCEventShow');
$("#obj9038").trigger('SCEventShow');
