...
pubcoder.page.id = pubcoder.page.id || 3989;
...
function switchImage_11686() {
	...
	var switchHelperId = "switchHelper188"
	var switchHelperRef = "#switchHelper188"
	var switchId = "188";
	var toSwitchId = "188";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj3990").trigger('SCEventShow');
$("#obj4382").trigger('SCEventShow');
$("#obj4384").trigger('SCEventShow');
$("#obj3992").trigger('SCEventShow');
$("#obj4386").trigger('SCEventShow');
$("#obj3994").trigger('SCEventShow');
$("#obj4097").trigger('SCEventShow');
$("#obj9040").trigger('SCEventShow');
