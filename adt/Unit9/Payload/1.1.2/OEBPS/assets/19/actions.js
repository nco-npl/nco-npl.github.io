...
pubcoder.page.id = pubcoder.page.id || 3799;
 ...
 * 
 */
var obj9906_onTap_activeActionGroupIndex = -1;
var obj9906_onTap_runningActionsCount = 0;
var obj9906_onTap_loopCount = 0;
...
obj9906_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9906_onTap_activeActionGroupIndex = -1;
		$("#obj9906").trigger("obj9906_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9906) {
				console.warn("de-queueing event obj9906." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9906").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9906_onTap_activeActionGroupIndex = 0;
...
runjs_9910();
function runjs_9910() {
	window.obj9906_onTap_runningActionsCount = obj9906_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9906_onTap_runningActionsCount = window.obj9906_onTap_runningActionsCount - 1;
if (window.obj9906_onTap_runningActionsCount < 0) {
	window.obj9906_onTap_runningActionsCount = 0;
} else if (window.obj9906_onTap_runningActionsCount == 0) {
	obj9906_onTap_actionGroup1();
}
	}, 1);
}
...
obj9906_onTap_actionGroup1 = function(){
...
function switchImage_11692() {
	...
	var switchHelperId = "switchHelper194"
	var switchHelperRef = "#switchHelper194"
	var switchId = "194";
	var toSwitchId = "194";
	var fadeDuration = "0s";
...
function switchImage_11698() {
	...
	var switchHelperId = "switchHelper195"
	var switchHelperRef = "#switchHelper195"
	var switchId = "195";
	var toSwitchId = "195";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj9906: Event Touch Down
 *
 */
$("#obj9906").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9906_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9906_onTap is still running");
	return;
}
var obj9906_onTap_runningActionsCount = 0;
var obj9906_onTap_loopCount = 0;
obj9906_onTap_actionGroup0();
});
...
$("#obj9906").trigger('SCEventShow');
$("#obj9042").trigger('SCEventShow');
