 ...
 * 
 */
var obj9920_onTap_activeActionGroupIndex = -1;
var obj9920_onTap_runningActionsCount = 0;
var obj9920_onTap_loopCount = 0;
...
obj9920_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj9920_onTap_activeActionGroupIndex = -1;
		$("#obj9920").trigger("obj9920_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 9920) {
				console.warn("de-queueing event obj9920." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj9920").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj9920_onTap_activeActionGroupIndex = 0;
...
runjs_9924();
function runjs_9924() {
	window.obj9920_onTap_runningActionsCount = obj9920_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj9920_onTap_runningActionsCount = window.obj9920_onTap_runningActionsCount - 1;
if (window.obj9920_onTap_runningActionsCount < 0) {
	window.obj9920_onTap_runningActionsCount = 0;
} else if (window.obj9920_onTap_runningActionsCount == 0) {
	obj9920_onTap_actionGroup1();
}
	}, 1);
}
...
obj9920_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj9920: Event Touch Down
 *
 */
$("#obj9920").bind(PubCoder.Events.Tap + " keydown", function(event) {
	if (event.type === "keydown" && event.key !== "Enter") return;
	event.preventDefault();
	if (window.obj9920_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj9920_onTap is still running");
	return;
}
var obj9920_onTap_runningActionsCount = 0;
var obj9920_onTap_loopCount = 0;
obj9920_onTap_actionGroup0();
});
...
$("#obj9768").trigger('SCEventShow');
$("#obj4538").trigger('SCEventShow');
$("#obj4540").trigger('SCEventShow');
$("#obj4054").trigger('SCEventShow');
$("#obj9771").trigger('SCEventShow');
$("#obj4546").trigger('SCEventShow');
$("#obj4544").trigger('SCEventShow');
$("#obj4548").trigger('SCEventShow');
$("#obj4542").trigger('SCEventShow');
$("#obj4113").trigger('SCEventShow');
$("#obj9920").trigger('SCEventShow');
$("#obj9056").trigger('SCEventShow');
