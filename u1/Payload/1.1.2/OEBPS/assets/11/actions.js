...
//	target: obj4564 
switchImage_6875();
function switchImage_6875() {
	window.obj2168_onTap_runningActionsCount = obj2168_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4564";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4564_img";
	var fromImagePath = "../images/obj2168_image.png";
	var toImagePath = "../images/switch127_to.png";
	var switchHelperId = "switchHelper127"
	var switchHelperRef = "#switchHelper127"
	var switchId = "127";
	var toSwitchId = "127";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6875_from";
	var toSoundObjectId = "#obj_audio_switchImage6875_to";
	var audioFrom;
...
//	target: obj4568 
switchImage_6882();
function switchImage_6882() {
	window.obj2170_onTap_runningActionsCount = obj2170_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4568";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4568_img";
	var fromImagePath = "../images/obj2170_image.png";
	var toImagePath = "../images/switch127_to.png";
	...
	var toSwitchId = "130";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6882_from";
	var toSoundObjectId = "#obj_audio_switchImage6882_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4570 
switchImage_6883();
function switchImage_6883() {
	window.obj2172_onTap_runningActionsCount = obj2172_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4570";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4570_img";
	var fromImagePath = "../images/obj2172_image.png";
	var toImagePath = "../images/switch127_to.png";
	var switchHelperId = "switchHelper133"
	var switchHelperRef = "#switchHelper133"
	var switchId = "133";
	var toSwitchId = "133";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6883_from";
	var toSoundObjectId = "#obj_audio_switchImage6883_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4566 
switchImage_6881();
function switchImage_6881() {
	window.obj2174_onTap_runningActionsCount = obj2174_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4566";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4566_img";
	var fromImagePath = "../images/obj2174_image.png";
	var toImagePath = "../images/switch127_to.png";
	var switchHelperId = "switchHelper136"
	var switchHelperRef = "#switchHelper136"
	var switchId = "136";
	var toSwitchId = "136";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6881_from";
	var toSoundObjectId = "#obj_audio_switchImage6881_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4574 
switchImage_6885();
function switchImage_6885() {
	window.obj2176_onTap_runningActionsCount = obj2176_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4574";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4574_img";
	var fromImagePath = "../images/obj2176_image.png";
	var toImagePath = "../images/switch127_to.png";
	...
	var toSwitchId = "139";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6885_from";
	var toSoundObjectId = "#obj_audio_switchImage6885_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4578 
switchImage_6887();
function switchImage_6887() {
	window.obj2178_onTap_runningActionsCount = obj2178_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4578";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4578_img";
	var fromImagePath = "../images/obj2178_image.png";
	var toImagePath = "../images/switch127_to.png";
	...
	var toSwitchId = "142";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6887_from";
	var toSoundObjectId = "#obj_audio_switchImage6887_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4576 
switchImage_6886();
function switchImage_6886() {
	window.obj2180_onTap_runningActionsCount = obj2180_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4576";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4576_img";
	var fromImagePath = "../images/obj2180_image.png";
	var toImagePath = "../images/switch127_to.png";
	var switchHelperId = "switchHelper145"
	var switchHelperRef = "#switchHelper145"
	var switchId = "145";
	var toSwitchId = "145";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6886_from";
	var toSoundObjectId = "#obj_audio_switchImage6886_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4580 
switchImage_6888();
function switchImage_6888() {
	window.obj2182_onTap_runningActionsCount = obj2182_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4580";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4580_img";
	var fromImagePath = "../images/obj2182_image.png";
	var toImagePath = "../images/switch127_to.png";
	var switchHelperId = "switchHelper148"
	var switchHelperRef = "#switchHelper148"
	var switchId = "148";
	var toSwitchId = "148";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6888_from";
	var toSoundObjectId = "#obj_audio_switchImage6888_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4586 
switchImage_6890();
function switchImage_6890() {
	window.obj2184_onTap_runningActionsCount = obj2184_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4586";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4586_img";
	var fromImagePath = "../images/obj2184_image.png";
	var toImagePath = "../images/switch127_to.png";
	var switchHelperId = "switchHelper151"
	var switchHelperRef = "#switchHelper151"
	var switchId = "151";
	var toSwitchId = "151";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6890_from";
	var toSoundObjectId = "#obj_audio_switchImage6890_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4584 
switchImage_6891();
function switchImage_6891() {
	window.obj2186_onTap_runningActionsCount = obj2186_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4584";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4584_img";
	var fromImagePath = "../images/obj2186_image.png";
	var toImagePath = "../images/switch127_to.png";
	...
	var toSwitchId = "154";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6891_from";
	var toSoundObjectId = "#obj_audio_switchImage6891_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4588 
switchImage_6892();
function switchImage_6892() {
	window.obj2188_onTap_runningActionsCount = obj2188_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4588";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4588_img";
	var fromImagePath = "../images/obj2188_image.png";
	var toImagePath = "../images/switch127_to.png";
	var switchHelperId = "switchHelper157"
	var switchHelperRef = "#switchHelper157"
	var switchId = "157";
	var toSwitchId = "157";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6892_from";
	var toSoundObjectId = "#obj_audio_switchImage6892_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4582 
switchImage_6889();
function switchImage_6889() {
	window.obj2190_onTap_runningActionsCount = obj2190_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4582";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4582_img";
	var fromImagePath = "../images/obj2190_image.png";
	var toImagePath = "../images/switch127_to.png";
	var switchHelperId = "switchHelper160"
	var switchHelperRef = "#switchHelper160"
	var switchId = "160";
	var toSwitchId = "160";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6889_from";
	var toSoundObjectId = "#obj_audio_switchImage6889_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
//	target: obj4572 
switchImage_6884();
function switchImage_6884() {
	window.obj2192_onTap_runningActionsCount = obj2192_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj4572";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj4572_img";
	var fromImagePath = "../images/obj2192_image.png";
	var toImagePath = "../images/switch127_to.png";
	var switchHelperId = "switchHelper163"
	var switchHelperRef = "#switchHelper163"
	var switchId = "163";
	var toSwitchId = "163";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#obj_audio_switchImage6884_from";
	var toSoundObjectId = "#obj_audio_switchImage6884_to";
	var audioFrom;
	if (fromSoundObjectId != "#") audioFrom = $(fromSoundObjectId)[0];
	var audioTo;
	if (toSoundObjectId != "#") audioTo = $(toSoundObjectId)[0];
...
function switchImage_2939() {
	...
	var switchHelperId = "switchHelper167"
	var switchHelperRef = "#switchHelper167"
	var switchId = "167";
	var toSwitchId = "167";
	var fadeDuration = "0s";
...
$("#obj4584").trigger('SCEventShow');
$("#obj4586").trigger('SCEventShow');
$("#obj4588").trigger('SCEventShow');
$("#obj6752").trigger('SCEventShow');
