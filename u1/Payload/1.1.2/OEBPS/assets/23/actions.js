...
function switchImage_2028() {
	...
	var fromImagePath = "../images/obj2014_image.png";
	var toImagePath = "../images/switch372_to.png";
	var switchHelperId = "switchHelper381"
	var switchHelperRef = "#switchHelper381"
	var switchId = "381";
	var toSwitchId = "381";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_7027() {
	...
	var toImagePath = "../images/switch372_to.png";
	var switchHelperId = "switchHelper388"
	var switchHelperRef = "#switchHelper388"
	var switchId = "388";
	var toSwitchId = "388";
	var fadeDuration = "0s";
...
function switchImage_7029() {
	...
	var toImagePath = "../images/switch372_to.png";
	var switchHelperId = "switchHelper397"
	var switchHelperRef = "#switchHelper397"
	var switchId = "397";
	var toSwitchId = "397";
	var fadeDuration = "0s";
 ...
 *
 */
$("#obj2032").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
 ...
 *
 */
$("#obj2035").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
 ...
 *
 */
$("#obj2037").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
 ...
 *
 */
$("#obj2039").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
 ...
 *
 */
$("#obj2041").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
