...
pubcoder.page.id = pubcoder.page.id || 1492;
...
var drawerObj2047 = new Drawer('obj2047', {
...
function switchImage_2939() {
	...
	var switchHelperId = "switchHelper414"
	var switchHelperRef = "#switchHelper414"
	var switchId = "414";
	var toSwitchId = "414";
	var fadeDuration = "0s";
...
$("#obj1802").trigger('SCEventShow');
$("#obj2047").trigger('SCEventShow');
$("#obj2505").trigger('SCEventShow');
