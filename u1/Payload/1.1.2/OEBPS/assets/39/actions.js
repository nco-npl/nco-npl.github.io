...
pubcoder.page.id = pubcoder.page.id || 1503;
 ...
 * 
 */
var obj2295_onTap_activeActionGroupIndex = -1;
var obj2295_onTap_runningActionsCount = 0;
var obj2295_onTap_loopCount = 0;
...
obj2295_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj2295_onTap_activeActionGroupIndex = -1;
		$("#obj2295").trigger("obj2295_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 2295) {
				console.warn("de-queueing event obj2295." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj2295").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj2295_onTap_activeActionGroupIndex = 0;
...
//	target: obj4725 
switchImage_7036();
function switchImage_7036() {
	window.obj2295_onTap_runningActionsCount = obj2295_onTap_runningActionsCount + 1;
	...
	var switchHelperId = "switchHelper571"
	var switchHelperRef = "#switchHelper571"
	var switchId = "571";
	var toSwitchId = "571";
	var fadeDuration = "0s";
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj2295_onTap_runningActionsCount = window.obj2295_onTap_runningActionsCount - 1;
if (window.obj2295_onTap_runningActionsCount < 0) {
	window.obj2295_onTap_runningActionsCount = 0;
} else if (window.obj2295_onTap_runningActionsCount == 0) {
	obj2295_onTap_actionGroup1();
}
			}, 1);
	};
...
obj2295_onTap_actionGroup1 = function(){
...
obj2297_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj2297_onTap_activeActionGroupIndex = -1;
		$("#obj2297").trigger("obj2297_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 2297) {
				console.warn("de-queueing event obj2297." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj2297").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj2297_onTap_activeActionGroupIndex = 0;
...
//	target: obj4729 
switchImage_7037();
function switchImage_7037() {
	window.obj2297_onTap_runningActionsCount = obj2297_onTap_runningActionsCount + 1;
	...
	var toImagePath = "../images/switch372_to.png";
	var switchHelperId = "switchHelper574"
	var switchHelperRef = "#switchHelper574"
	var switchId = "574";
	var toSwitchId = "574";
	var fadeDuration = "0s";
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj2297_onTap_runningActionsCount = window.obj2297_onTap_runningActionsCount - 1;
if (window.obj2297_onTap_runningActionsCount < 0) {
	window.obj2297_onTap_runningActionsCount = 0;
} else if (window.obj2297_onTap_runningActionsCount == 0) {
	obj2297_onTap_actionGroup1();
}
			}, 1);
	};
	var originalImage = $(targetObjectId).attr("data-SCActionSwitchImage-originalImage");
...
obj2297_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj2297_onTap_activeActionGroupIndex = -1;
		$("#obj2297").trigger("obj2297_onTap_ended");
...
function switchImage_4727() {
	...
	var toImagePath = "../images/switch372_to.png";
	var switchHelperId = "switchHelper578"
	var switchHelperRef = "#switchHelper578"
	var switchId = "578";
	var toSwitchId = "578";
	var fadeDuration = "0s";
...
function switchImage_4731() {
	...
	var fromImagePath = "../images/obj2014_image.png";
	var toImagePath = "../images/switch372_to.png";
	var switchHelperId = "switchHelper580"
	var switchHelperRef = "#switchHelper580"
	var switchId = "580";
	var toSwitchId = "580";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2939() {
	...
	var switchHelperId = "switchHelper582"
	var switchHelperRef = "#switchHelper582"
	var switchId = "582";
	var toSwitchId = "582";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2945() {
	...
	var switchHelperId = "switchHelper583"
	var switchHelperRef = "#switchHelper583"
	var switchId = "583";
	var toSwitchId = "583";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2931() {
	...
	var switchHelperId = "switchHelper584"
	var switchHelperRef = "#switchHelper584"
	var switchId = "584";
	var toSwitchId = "584";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2926() {
	...
	var switchHelperId = "switchHelper585"
	var switchHelperRef = "#switchHelper585"
	var switchId = "585";
	var toSwitchId = "585";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj2295: Event Touch Down
 *
 */
$("#obj2295").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj2295_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj2295_onTap is still running");
	return;
}
var obj2295_onTap_runningActionsCount = 0;
var obj2295_onTap_loopCount = 0;
obj2295_onTap_actionGroup0();
});
...
/*
 *
 *   obj2297: Event Touch Down
 *
 */
$("#obj2297").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj2297_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj2297_onTap is still running");
	return;
}
var obj2297_onTap_runningActionsCount = 0;
var obj2297_onTap_loopCount = 0;
obj2297_onTap_actionGroup0();
});
 ...
 *
 */
$("#obj4725").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
 ...
 *
 */
$("#obj4729").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
...
$("#obj1832").trigger('SCEventShow');
$("#obj2295").trigger('SCEventShow');
$("#obj2297").trigger('SCEventShow');
$("#obj4725").trigger('SCEventShow');
$("#obj4729").trigger('SCEventShow');
