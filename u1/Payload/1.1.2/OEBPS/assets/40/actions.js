...
pubcoder.page.id = pubcoder.page.id || 1504;
...
function switchImage_2939() {
	...
	var switchHelperId = "switchHelper589"
	var switchHelperRef = "#switchHelper589"
	var switchId = "589";
	var toSwitchId = "589";
	var fadeDuration = "0s";
...
function switchImage_2945() {
	...
	var switchHelperId = "switchHelper590"
	var switchHelperRef = "#switchHelper590"
	var switchId = "590";
	var toSwitchId = "590";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2931() {
	...
	var switchHelperId = "switchHelper591"
	var switchHelperRef = "#switchHelper591"
	var switchId = "591";
	var toSwitchId = "591";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2926() {
	...
	var switchHelperId = "switchHelper592"
	var switchHelperRef = "#switchHelper592"
	var switchId = "592";
	var toSwitchId = "592";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
