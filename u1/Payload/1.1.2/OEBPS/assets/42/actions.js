...
pubcoder.page.id = pubcoder.page.id || 1506;
...
function switchImage_2939() {
	...
	var switchHelperId = "switchHelper605"
	var switchHelperRef = "#switchHelper605"
	var switchId = "605";
	var toSwitchId = "605";
	var fadeDuration = "0s";
...
function switchImage_2945() {
	...
	var switchHelperId = "switchHelper606"
	var switchHelperRef = "#switchHelper606"
	var switchId = "606";
	var toSwitchId = "606";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2931() {
	...
	var switchHelperId = "switchHelper607"
	var switchHelperRef = "#switchHelper607"
	var switchId = "607";
	var toSwitchId = "607";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2926() {
	...
	var switchHelperId = "switchHelper608"
	var switchHelperRef = "#switchHelper608"
	var switchId = "608";
	var toSwitchId = "608";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj1632").trigger('SCEventShow');
$("#obj4544").trigger('SCEventShow');
$("#obj1838").trigger('SCEventShow');
$("#obj2307").trigger('SCEventShow');
$("#obj2309").trigger('SCEventShow');
$("#obj2311").trigger('SCEventShow');
$("#obj2313").trigger('SCEventShow');
$("#obj2315").trigger('SCEventShow');
$("#obj2317").trigger('SCEventShow');
$("#obj2319").trigger('SCEventShow');
$("#obj2321").trigger('SCEventShow');
$("#obj2582").trigger('SCEventShow');
$("#obj2584").trigger('SCEventShow');
