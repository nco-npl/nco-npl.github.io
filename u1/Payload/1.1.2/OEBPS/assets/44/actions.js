...
pubcoder.page.id = pubcoder.page.id || 1508;
 ...
 * 
 */
var obj6765_onTap_activeActionGroupIndex = -1;
var obj6765_onTap_runningActionsCount = 0;
var obj6765_onTap_loopCount = 0;
...
obj6765_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6765_onTap_activeActionGroupIndex = -1;
		$("#obj6765").trigger("obj6765_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 6765) {
				console.warn("de-queueing event obj6765." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj6765").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj6765_onTap_activeActionGroupIndex = 0;
...
runjs_6769();
function runjs_6769() {
	window.obj6765_onTap_runningActionsCount = obj6765_onTap_runningActionsCount + 1;
	...
	setTimeout(function() {
		window.obj6765_onTap_runningActionsCount = window.obj6765_onTap_runningActionsCount - 1;
if (window.obj6765_onTap_runningActionsCount < 0) {
	window.obj6765_onTap_runningActionsCount = 0;
} else if (window.obj6765_onTap_runningActionsCount == 0) {
	obj6765_onTap_actionGroup1();
}
	}, 1);
}
...
obj6765_onTap_actionGroup1 = function(){
...
function switchImage_2939() {
	...
	var switchHelperId = "switchHelper623"
	var switchHelperRef = "#switchHelper623"
	var switchId = "623";
	var toSwitchId = "623";
	var fadeDuration = "0s";
...
function switchImage_2945() {
	...
	var switchHelperId = "switchHelper624"
	var switchHelperRef = "#switchHelper624"
	var switchId = "624";
	var toSwitchId = "624";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2931() {
	...
	var switchHelperId = "switchHelper625"
	var switchHelperRef = "#switchHelper625"
	var switchId = "625";
	var toSwitchId = "625";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2926() {
	...
	var switchHelperId = "switchHelper626"
	var switchHelperRef = "#switchHelper626"
	var switchId = "626";
	var toSwitchId = "626";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj6765: Event Touch Down
 *
 */
$("#obj6765").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj6765_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj6765_onTap is still running");
	return;
}
var obj6765_onTap_runningActionsCount = 0;
var obj6765_onTap_loopCount = 0;
obj6765_onTap_actionGroup0();
});
...
$("#obj1638").trigger('SCEventShow');
$("#obj1641").trigger('SCEventShow');
$("#obj1644").trigger('SCEventShow');
$("#obj1647").trigger('SCEventShow');
$("#obj2588").trigger('SCEventShow');
$("#obj2590").trigger('SCEventShow');
$("#obj2592").trigger('SCEventShow');
$("#obj4761").trigger('SCEventShow');
$("#obj4780").trigger('SCEventShow');
$("#obj6765").trigger('SCEventShow');
