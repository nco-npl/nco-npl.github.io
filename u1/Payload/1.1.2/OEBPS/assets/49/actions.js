...
pubcoder.page.id = pubcoder.page.id || 1513;
...
function switchImage_2939() {
	...
	var switchHelperId = "switchHelper668"
	var switchHelperRef = "#switchHelper668"
	var switchId = "668";
	var toSwitchId = "668";
	var fadeDuration = "0s";
...
function switchImage_2945() {
	...
	var switchHelperId = "switchHelper669"
	var switchHelperRef = "#switchHelper669"
	var switchId = "669";
	var toSwitchId = "669";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2931() {
	...
	var switchHelperId = "switchHelper670"
	var switchHelperRef = "#switchHelper670"
	var switchId = "670";
	var toSwitchId = "670";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2926() {
	...
	var switchHelperId = "switchHelper671"
	var switchHelperRef = "#switchHelper671"
	var switchId = "671";
	var toSwitchId = "671";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj1662").trigger('SCEventShow');
$("#obj4558").trigger('SCEventShow');
$("#obj1852").trigger('SCEventShow');
$("#obj2384").trigger('SCEventShow');
$("#obj2642").trigger('SCEventShow');
