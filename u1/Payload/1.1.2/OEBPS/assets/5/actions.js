...
pubcoder.page.id = pubcoder.page.id || 741;
 ...
 * 
 */
var obj1167_onTap_activeActionGroupIndex = -1;
var obj1167_onTap_runningActionsCount = 0;
var obj1167_onTap_loopCount = 0;
var obj1169_onTap_activeActionGroupIndex = -1;
var obj1169_onTap_runningActionsCount = 0;
var obj1169_onTap_loopCount = 0;
...
obj1167_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1167_onTap_activeActionGroupIndex = -1;
		$("#obj1167").trigger("obj1167_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 1167) {
				console.warn("de-queueing event obj1167." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj1167").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj1167_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj1161
(function(){
	window.obj1167_onTap_runningActionsCount = obj1167_onTap_runningActionsCount + 1;

	var selector = "#obj1161";
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				...
				if (isLast) {
					window.obj1167_onTap_runningActionsCount = window.obj1167_onTap_runningActionsCount - 1;
if (window.obj1167_onTap_runningActionsCount < 0) {
	window.obj1167_onTap_runningActionsCount = 0;
} else if (window.obj1167_onTap_runningActionsCount == 0) {
	obj1167_onTap_actionGroup1();
}
				}
...
obj1167_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1167_onTap_activeActionGroupIndex = -1;
		$("#obj1167").trigger("obj1167_onTap_ended");
...
//	action: hide
//	selector: obj#obj1164 
hide_2466();
function hide_2466() {
	var selector = "#obj1164";
...
obj1167_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1167_onTap_activeActionGroupIndex = -1;
		$("#obj1167").trigger("obj1167_onTap_ended");
	...
	window.obj1167_onTap_activeActionGroupIndex = 2;
...
playAudioFile_6930();
function playAudioFile_6930() {
	window.obj1167_onTap_runningActionsCount = obj1167_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile6930")[0];
	...
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile6930");
			$("#obj_audio_playSoundFile6930").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj1167_onTap_runningActionsCount = window.obj1167_onTap_runningActionsCount - 1;
if (window.obj1167_onTap_runningActionsCount < 0) {
	window.obj1167_onTap_runningActionsCount = 0;
} else if (window.obj1167_onTap_runningActionsCount == 0) {
	obj1167_onTap_actionGroup3();
}
			});
		} else {
...
obj1167_onTap_actionGroup3 = function(){
	...
	window.obj1167_onTap_activeActionGroupIndex = 3;
...
obj1169_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1169_onTap_activeActionGroupIndex = -1;
		$("#obj1169").trigger("obj1169_onTap_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 1169) {
				console.warn("de-queueing event obj1169." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj1169").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj1169_onTap_activeActionGroupIndex = 0;
	

//	action: show 
//	selector: #obj1164
(function(){
	window.obj1169_onTap_runningActionsCount = obj1169_onTap_runningActionsCount + 1;
	...
	function showObject(element, isLast) {
		...
		if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
			setTimeout(function() {
				$(element).css("display", "block");
				if (isLast) {
					window.obj1169_onTap_runningActionsCount = window.obj1169_onTap_runningActionsCount - 1;
if (window.obj1169_onTap_runningActionsCount < 0) {
	window.obj1169_onTap_runningActionsCount = 0;
} else if (window.obj1169_onTap_runningActionsCount == 0) {
	obj1169_onTap_actionGroup1();
}
				}
				$(element).trigger('SCEventShow');
			}, 1);
...
obj1169_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1169_onTap_activeActionGroupIndex = -1;
		$("#obj1169").trigger("obj1169_onTap_ended");
...
obj1169_onTap_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1169_onTap_activeActionGroupIndex = -1;
		$("#obj1169").trigger("obj1169_onTap_ended");
	...
	window.obj1169_onTap_activeActionGroupIndex = 2;
...
//	action: playAudioFile
playAudioFile_6931();
function playAudioFile_6931() {
	window.obj1169_onTap_runningActionsCount = obj1169_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile6931")[0];
	var playFromBeginning = true;
	var waitForCompletion = true;
	var useReader = typeof(window.XPUB.readerPrefersToHandleAudio) !== "undefined" ?
		window.XPUB.readerPrefersToHandleAudio : (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase()));
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile6931");
			$("#obj_audio_playSoundFile6931").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj1169_onTap_runningActionsCount = window.obj1169_onTap_runningActionsCount - 1;
if (window.obj1169_onTap_runningActionsCount < 0) {
	window.obj1169_onTap_runningActionsCount = 0;
} else if (window.obj1169_onTap_runningActionsCount == 0) {
	obj1169_onTap_actionGroup3();
}
			});
		} else {
			XPUB.playAudio(myAudio.src, playFromBeginning, null);
...
obj1169_onTap_actionGroup3 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj1169_onTap_activeActionGroupIndex = -1;
		$("#obj1169").trigger("obj1169_onTap_ended");
	...
	window.obj1169_onTap_activeActionGroupIndex = 3;
...
function switchImage_2926() {
	...
	var switchHelperId = "switchHelper77"
	var switchHelperRef = "#switchHelper77"
	var switchId = "77";
	var toSwitchId = "77";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
/*
 *
 *   obj1167: Event Touch Down
 *
 */
$("#obj1167").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj1167_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj1167_onTap is still running");
	return;
}
var obj1167_onTap_runningActionsCount = 0;
var obj1167_onTap_loopCount = 0;
obj1167_onTap_actionGroup0();
});
...
/*
 *
 *   obj1169: Event Touch Down
 *
 */
$("#obj1169").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj1169_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj1169_onTap is still running");
	return;
}
var obj1169_onTap_runningActionsCount = 0;
var obj1169_onTap_loopCount = 0;
obj1169_onTap_actionGroup0();
});
