...
pubcoder.page.id = pubcoder.page.id || 1514;
...
function switchImage_2939() {
	...
	var switchHelperId = "switchHelper677"
	var switchHelperRef = "#switchHelper677"
	var switchId = "677";
	var toSwitchId = "677";
	var fadeDuration = "0s";
...
function switchImage_2945() {
	...
	var switchHelperId = "switchHelper678"
	var switchHelperRef = "#switchHelper678"
	var switchId = "678";
	var toSwitchId = "678";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2931() {
	...
	var switchHelperId = "switchHelper679"
	var switchHelperRef = "#switchHelper679"
	var switchId = "679";
	var toSwitchId = "679";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2926() {
	...
	var switchHelperId = "switchHelper680"
	var switchHelperRef = "#switchHelper680"
	var switchId = "680";
	var toSwitchId = "680";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj2386").trigger('SCEventShow');
$("#obj2638").trigger('SCEventShow');
$("#obj2640").trigger('SCEventShow');
