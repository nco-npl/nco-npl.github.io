...
obj1898_onTap_actionGroup0 = function(){
	...
	if (isLastActionGroup) {
		...
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			...
			if (evt.senderObjectId == 1898) {
				console.warn("de-queueing event obj1898." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj1898").trigger(evt.eventName);
				return;
			}
		}
		return;
...
//	target: obj1898 
switchImage_1967();
function switchImage_1967() {
	window.obj1898_onTap_runningActionsCount = obj1898_onTap_runningActionsCount + 1;

	var targetObjectId = "#obj1898";
	var targetObject = $(targetObjectId)[0];
	var allowBackAndForth = true;
	var imgObjId = "#obj1898_img";
	...
	var actionEndFunction = function() {
			setTimeout(function() {
				window.obj1898_onTap_runningActionsCount = window.obj1898_onTap_runningActionsCount - 1;
if (window.obj1898_onTap_runningActionsCount < 0) {
	window.obj1898_onTap_runningActionsCount = 0;
} else if (window.obj1898_onTap_runningActionsCount == 0) {
	obj1898_onTap_actionGroup1();
}
			}, 1);
	};
...
playAudioFile_4683();
function playAudioFile_4683() {
	window.obj1898_onTap_runningActionsCount = obj1898_onTap_runningActionsCount + 1;
	var myAudio = $("#obj_audio_playSoundFile4683")[0];
	...
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile4683");
			$("#obj_audio_playSoundFile4683").one('ended', function() {
				// this.removeEventListener('ended',arguments.callee,false);
				window.obj1898_onTap_runningActionsCount = window.obj1898_onTap_runningActionsCount - 1;
if (window.obj1898_onTap_runningActionsCount < 0) {
	window.obj1898_onTap_runningActionsCount = 0;
} else if (window.obj1898_onTap_runningActionsCount == 0) {
	obj1898_onTap_actionGroup2();
}
			});
		} else {
...
obj1898_onTap_actionGroup2 = function(){
	...
	window.obj1898_onTap_activeActionGroupIndex = 2;
...
function switchImage_1971() {
	...
	var fromImagePath = "../images/obj1898_image.png";
	var toImagePath = "../images/switch224_to.png";
	var switchHelperId = "switchHelper226"
	var switchHelperRef = "#switchHelper226"
	var switchId = "226";
	var toSwitchId = "226";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_1977() {
	...
	var fromImagePath = "../images/obj1898_image.png";
	var toImagePath = "../images/switch224_to.png";
	var switchHelperId = "switchHelper228"
	var switchHelperRef = "#switchHelper228"
	var switchId = "228";
	var toSwitchId = "228";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_1975() {
	...
	var fromImagePath = "../images/obj1898_image.png";
	var toImagePath = "../images/switch224_to.png";
	var switchHelperId = "switchHelper236"
	var switchHelperRef = "#switchHelper236"
	var switchId = "236";
	var toSwitchId = "236";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2931() {
	...
	var switchHelperId = "switchHelper243"
	var switchHelperRef = "#switchHelper243"
	var switchId = "243";
	var toSwitchId = "243";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
function switchImage_2926() {
	...
	var switchHelperId = "switchHelper244"
	var switchHelperRef = "#switchHelper244"
	var switchId = "244";
	var toSwitchId = "244";
	var fadeDuration = "0s";
	var fromSoundObjectId = "#";
...
$("#obj1898").bind(PubCoder.Events.Tap, function(event) {
	...
	if (window.obj1898_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj1898_onTap is still running");
	return;
}
var obj1898_onTap_runningActionsCount = 0;
var obj1898_onTap_loopCount = 0;
